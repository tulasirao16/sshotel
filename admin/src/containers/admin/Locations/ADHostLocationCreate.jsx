...
import ADHostLocationsCreateComponent from '../../../components/admin/Locations/ADHostLocationCreateComponent'

class ADHostLocationsCreate extends React.Component {
  constructor () {
    super()
    this.state = {
    ...
    return (
      <div>
        <div className='main-content' id='panel'>
                  ...
                  <div className='col'>
                    ...
                    <nav aria-label='breadcrumb' className='d-none d-md-inline-block ml-md-4'>
                      <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                        ...
                        <li className='breadcrumb-item active' aria-current='page'>{ t`lanSPTitleLocationCreate` }</li>
                      </ol>
                    </nav>
                  </div>
                </div>
          ...
          {/* ---------- Header Starts ------------- */}
          <ADHostLocationsCreateComponent />
          <FooterComponent />
        </div>
      </div>
    )
...
export default ADHostLocationsCreate
