...
import ADHostUserListViewComponent from '../../../components/admin/HostUsers/ADHostUserListViewComponent'

class ADHostUserListView extends React.Component {
  constructor () {
    super()
    this.state = {
                  ...
                  <div className='col'>
                    ...
                    <nav aria-label='breadcrumb' className='d-none d-md-inline-block ml-md-4'>
                      <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                        ...
                        <li className='breadcrumb-item active' aria-current='page'>{ t`lanADTooltipLabelHostUserView` }</li>
                      </ol>
                    </nav>
                  </div>
                </div>
...
export default ADHostUserListView
