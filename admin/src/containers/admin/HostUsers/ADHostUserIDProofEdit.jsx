...
import ADHostUserIDProofEditComponent from '../../../components/admin/HostUsers/ADHostUserIDProofEditComponent'

class ADHostUserIDProofEdit extends React.Component {
  constructor () {
    super()
    this.state = {
    ...
    return (
      <div>
        <div className='main-content' id='panel'>
                  ...
                  <div className='col'>
                    ...
                    <nav aria-label='breadcrumb' className='d-none d-md-inline-block ml-md-4'>
                      <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                        ...
                        <li className='breadcrumb-item active' aria-current='page'><a>{ t`lanADTooltipLabelHostUserView` }</a></li>
                      </ol>
                    </nav>
                  </div>
                </div>
          ...
          {/* ---------- Header Starts ------------- */}
          <ADHostUserIDProofEditComponent />
          <FooterComponent />
        </div>
      </div>
    )
...
export default ADHostUserIDProofEdit
