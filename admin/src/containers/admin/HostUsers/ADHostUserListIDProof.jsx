...
import ADHostUserListIDProofComponent from '../../../components/admin/HostUsers/ADHostUserListIDProofComponent'

class ADHostUserListIDProof extends React.Component {
  constructor () {
    super()
    this.state = {
    ...
    return (
      <div>
        <div className='main-content' id='panel'>
                  ...
                  <div className='col'>
                    ...
                    <nav aria-label='breadcrumb' className='d-none d-md-inline-block ml-md-4'>
                      <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                        ...
                        <li className='breadcrumb-item active' aria-current='page'>{ t`lanADTooltipLabelHostUserIDProof` }</li>
                      </ol>
                    </nav>
                  </div>
                </div>
          ...
          {/* ---------- Header Starts ------------- */}
          <ADHostUserListIDProofComponent />
          <FooterComponent />
        </div>
      </div>
    )
...
export default ADHostUserListIDProof
