                    ...
                    <div className='row'>
                      ...
                      <div className='col-md-3 pr-1'>
                        <div className='form-group'>
                          ...
                          <select className='form-control' id='exampleFormControlSelect1' onChange={this.handleSelectGender} value={this.state.userInfo.gender} >
                  ...
                  <form>
                    ...
                    <div className='row'>
                      ...
                      <div className='col-md-3 pr-1'>
                        <div className='form-group'>
                          ...
                          <select className='form-control' id='exampleFormControlSelect1' value={this.state.userInfo.country}>
                            <option>India</option>
                          </select>
                        </div>
                      </div>
                    ...
                    <div className='row'>
                      <div className='update ml-auto mr-auto'>
                        <button type='submit' className='btn btn-primary btn-round' onClick={this.handleUpdate}>{t`lanCommonButtonUpdate`}</button>
                        <ToastContainer rtl />
                      </div>
                    </div>
                  </form>
