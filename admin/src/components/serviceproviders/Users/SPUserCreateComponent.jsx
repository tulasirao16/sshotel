...
class SPUserCreateComponent extends React.Component {
  ...
  handleCreateUser () {
    ...
    if (!this.state.firstName.trim()) {
      ...
      let _this = this
      let obj = { url: config.baseUrl + config.postSPUserCreateAPI, body: userData }
          ...
          <form>
            ...
            <div className='row'>
              <div className='update ml-auto mr-auto'>
                <button type='submit' className='btn btn-primary btn-round' onClick={this.handleCreateUser}>{ t`lanCommonButtonCreate` }</button>
                <ToastContainer rtl />
              </div>
            </div>
          </form>
