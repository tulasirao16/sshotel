...
class SPDashboardBookingsListComponent extends React.Component {
  ...
  componentWillMount () {
    ...
    switch (type) {
      case 'CheckIn':
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeCheckInBookingsListAPI + this.state.activePage + '/' + this.state.searchString
        }
        break
      case 'CheckOut':
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeCheckOutBookingsListAPI + this.state.activePage + '/' + this.state.searchString
        }
        break
      case 'Bookings':
        this.setState({ heading: 'Bookings' })
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeTodayBookingsListAPI + this.state.activePage + '/' + this.state.searchString
        }
        break
      case 'Cancelled':
        this.setState({ heading: 'Cancelled Bookings' })
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeCancelledBookingsListAPI + this.state.activePage + '/' + this.state.searchString
        }
        break
      case 'Amounts':
        this.setState({ heading: 'Booking Amounts' })
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeAmountsBookingsListAPI + this.state.activePage + '/' + this.state.searchString
        }
        break
    }
  ...
  handleInputChange (event) {
    ...
    switch (type) {
      case 'CheckIn':
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeCheckInBookingsListAPI + '1' + '/' + event.target.value
        }
        break
      case 'CheckOut':
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeCheckOutBookingsListAPI + '1' + '/' + event.target.value
        }
        break
      case 'Bookings':
        this.setState({ heading: 'Bookings' })
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeTodayBookingsListAPI + '1' + '/' + event.target.value
        }
        break
      case 'Cancelled':
        this.setState({ heading: 'Cancelled Bookings' })
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeCancelledBookingsListAPI + '1' + '/' + event.target.value
        }
        break
      case 'Amounts':
        this.setState({ heading: 'Booking Amounts' })
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeAmountsBookingsListAPI + '1' + '/' + event.target.value
        }
        break
    }
  ...
  handlePageChange (pageNumber) {
    ...
    switch (type) {
      case 'CheckIn':
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeCheckInBookingsListAPI + pageNumber + '/' + this.state.searchString
        }
        break
      case 'CheckOut':
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeCheckOutBookingsListAPI + pageNumber + '/' + this.state.searchString
        }
        break
      case 'Bookings':
        this.setState({ heading: 'Bookings' })
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeTodayBookingsListAPI + pageNumber + '/' + this.state.searchString
        }
        break
      case 'Cancelled':
        this.setState({ heading: 'Cancelled Bookings' })
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeCancelledBookingsListAPI + pageNumber + '/' + this.state.searchString
        }
        break
      case 'Amounts':
        this.setState({ heading: 'Booking Amounts' })
        getSpBookingsObj = {
          url: config.baseUrl + config.getSPHomeAmountsBookingsListAPI + pageNumber + '/' + this.state.searchString
        }
        break
    }
  ...
  handleBookingCancel (data) {
    ...
    APICallManager.getCall(getSpBookingsObj, function (resObj) {
      if (resObj.data.statusCode === '0000') {
        ...
        alert('Sorry! You cant cancel this booking')
      }
    })
  }
  closeModal () {
