            ...
            <div className='header-body'>
              <div className='row align-items-center py-4'>
                <div className='col-lg-6 col-7'>
                  {/* <h6 className='h2 text-white d-inline-block mb-0'>{t`lanCommonButtonTooltipEditBooking`}</h6> */}
                      ...
                      <div className='row'>
                        ...
                        <div className='col-md-3'>
                          <div className='form-group'>
                            ...
                            <input type='text' value={this.state.bookingDate.euUserId.name} className='form-control' id='TicketSubject' readOnly />
                        ...
                        <div className='col-md-3'>
                          <div className='form-group'>
                            ...
                            <input type='text' value={this.state.bookingDate.euUserId.mobileNumber} className='form-control' id='ticketOn' />
