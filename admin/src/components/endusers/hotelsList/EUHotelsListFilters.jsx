    ...
    return (
      <div className='container-fluid filters-page pl-5'>
        <div className='row'>
            ...
            <form>
              <div className=' my-2 col-lg-12 px-0 '>
                <div className='input-group input-group-lg input-group-flush'>
                  ...
                  <input type='search' className='form-control eu-font' placeholder='Location Search...' value={this.state.location} onChange={this.handleSearchChange} />
                </div>
              </div>
            </form>
          </div>
          ...
          <div className='col-sm-2 mt-3 col-12 '>
          ...
          <div className='col-sm-2 mt-2 col-12'>
                  ...
                  <div className='row mb-2'>
                    <div className='col-sm-12 col-12'>
                      {this.state.predictions.map((predictions, index) => (
                        <a onClick={() => this.handleLocationData(predictions.description)} key={index}><div><label style={{ color: 'red' }} >{predictions.description}</label><br /></div></a>
                      ))}
                    </div>
                  </div>
                </div>
        ...
        >
          <div className='row p-2 modal-close' style={{ justifyContent: 'flex-end' }}>
            <button type='button' onClick={this.handleResetAll} className='btn btn-outline-success eu-font'>Reset All</button>
            ...
            <div className='row'>
              ...
              <div className='col-md-12 col-sm-12 col-xs-12 sub-menu mb-xl-0 mb-4'>
                ...
                <div className='row modal-btns' >
                  <button onClick={this.closeModal} className='btn btn-danger btn-text-white' type='button' >{t`lanCommonButtonCancel`}</button>
