                      ...
                      <div className='col-lg-3 col-sm-3 col-xs-12 text-center' key={i}>
                        <div className='host-box'>
                          <p className='card-category'>
                            ...
                            <span className='close-host'><a onClick={() => this.handleRemove(item)}><i className='fas fa-times' /></a></span></p>
                        </div>
                      </div>
                    )}
                  </div>
                        ...
                        <td>
                          <div className='row'>
                            <div className='col-sm-12 text-center' >
                              <a className='btn btn-danger btn-round' onClick={this.handleBack}>{t`lanCommonButtonBack`}</a>
                            </div>
                          </div>
                        </td>
