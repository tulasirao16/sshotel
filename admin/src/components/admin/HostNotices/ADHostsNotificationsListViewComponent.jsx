                ...
                <div className='col-lg-6 col-7'>
                  ...
                  <nav aria-label='breadcrumb eu eu-font' className='d-md-inline-block ml-md-4'>
                    <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                      ...
                      <li className='breadcrumb-item active eu-font'><a onClick={() => this.props.handleViewUser()}>{t`lanADTitleHostsNotificationList`}</a></li>
                      {/* <li className='breadcrumb-item'><a onClick={() => this.props.handleViewUser()}>Notifications List</a></li> */}
                      <li className='breadcrumb-item active' aria-current='page'>{t`lanADTitleHostsNotificationView`}</li>
                    </ol>
                  </nav>
                </div>
              </div>
            ...
            <div className='col-lg-10 card-wrapper'>
              <div className='card mb-2'>
                <div className='card-header bg-transparent px-5 pb-3 row'>
                  <h5 className='card-title col-sm-10'>{t`lanADTitleHostsNotificationView`}</h5>
                </div>
