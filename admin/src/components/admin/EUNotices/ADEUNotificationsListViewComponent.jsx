...
class ADEUNotificationsListViewComponent extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
...
ADEUNotificationsListViewComponent.propTypes = {
  notificationData: PropTypes.any,
  handleViewUser: PropTypes.any
}

export default ADEUNotificationsListViewComponent
