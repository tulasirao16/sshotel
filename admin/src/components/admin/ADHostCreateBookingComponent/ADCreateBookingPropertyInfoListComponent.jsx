...
class ADCreateBookingPropertyInfoList extends React.Component {
  ...
  componentWillMount () {
    ...
    let obj = { url: config.baseUrl + config.getADHostsPropertyInfosListAPI + propertyData._id }
    let _this = this
  ...
  handlePropertyInfoView (item) {
    ...
    hashHistory.push('/admin/host/properties/properties-infolist/create-booking')
  }
  render () {
    return (
      <div>
                      ...
                      <div className='row align-items-center'>
                        ...
                        <div className='col-md-4'>
                          <div className='input-group input-group-lg input-group-flush'>
                            ...
                            <input className='form-control mr-sm-2' type='Search' placeholder={t`lanCommonLabelSearch`} aria-label='Search' value={this.state.searchString} onChange={this.handleInputChange} />
                          </div>
                          {/* <h6 className='h2 text-white d-inline-block mb-0'>{t`lanSPTitlePropertyInfoList`}</h6> */}
                        </div>
                      </div>
...
ADCreateBookingPropertyInfoList.propTypes = {
