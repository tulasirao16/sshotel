...
import ADProfileIdProofCreateComponent from './ADProfileIdProofCreateComponent'
...
class ADProfileIdProofsListComponent extends React.Component {
  constructor () {
    super()
    this.state = {
      reload: false,
  ...
  componentWillMount () {
    ...
    let idproofsList = {
      url: config.baseUrl + config.getADProfileIdProofsListAPI
    }
    let _this = this
  ...
  handleEditIdProof (idProofData) {
    ...
    hashHistory.push('/admin/user/profile/edit')
    event.preventDefault()
  }
                ...
                <div className='col-lg-6 col-7'>
                  ...
                  <nav aria-label='breadcrumb' className='d-none d-md-inline-block ml-md-4'>
                    <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                      ...
                      <li className='breadcrumb-item active' aria-current='page'>ID Proofs</li>
                    </ol>
                  </nav>
                </div>
              </div>
                    ...
                    <ul className='list-unstyled team-members'>
                      <li>
                        <div className='row mobile'>
                          <div className='col-md-10 col-10 pl-4 text-left'>
                ...
                <div className='card-body'>
                  <Tabs onSelect={(index, label) => console.log(label + ' selected')} headerclassName='tab-header-bold' activeHeaderclassName='tab-header-blue'>
                    ...
                    <Tab label='Create ID Proof'>
                      <ADProfileIdProofCreateComponent handleIdProofCreate={this.handleIdProofCreated} />
                    </Tab>
                  </Tabs>
                </div>
              </div>
...
export default ADProfileIdProofsListComponent
