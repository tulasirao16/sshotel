...
class ADHostsSupportEditComponent extends React.Component {
  constructor (props) {
    super(props)
  ...
  handleUpdateSupport () {
    ...
    if (!this.state.ticketTitle) {
      ...
      let obj = { url: config.baseUrl + config.putADHostsSupportUpdateAPI + supportData._id, body: putJson }
      let _this = this
            ...
            <div className='col-lg-12 col-md-12'>
              <div className='card border-0 mb-0'>
                ...
                <div className='card-body card-ticket'>
                  ...
                  <div className='mt-2'>
                    <button disabled={this.state.buttonDisabled} className='btn btn-primary update-edit' onClick={this.handleUpdateSupport}>{t`lanCommonButtonUpdate`}</button>
                  </div>
...
ADHostsSupportEditComponent.propTypes = {
  selectedSupportData: PropTypes.any,
  handleBack: PropTypes.func,
  supportList:PropTypes.any
}
export default ADHostsSupportEditComponent
