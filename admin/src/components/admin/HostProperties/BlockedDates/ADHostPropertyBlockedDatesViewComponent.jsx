...
class ADHostPropertyBlockedDatesViewComponent extends React.Component {
  constructor () {
    super()
    this.state = {
      blockedDatesData: {},
  ...
  handleConfirmDeleteBlockedDates () {
    let obj = { url: config.baseUrl + config.deleteADHostPropertyBlockedDatesAPI + this.state.blockedDatesData._id }
    let _this = this
...
export default ADHostPropertyBlockedDatesViewComponent
