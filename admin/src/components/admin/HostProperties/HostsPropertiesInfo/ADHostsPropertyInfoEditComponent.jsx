...
export default class ADHostsPropertyInfoEditComponent extends React.Component {
  constructor (props) {
    super(props)
  ...
  handleInfoUpdate () {
    if (!this.state.rentType) {
      ...
      let obj = {
        url: config.baseUrl + config.putADHostsPropertyInfoUpdateAPI + this.state.propertyId + '/' + this.state.propertyInfoId,
        body: infoObj
      }
      ...
      APICallManager.putCall(obj, function (resObj) {
        if (resObj.data.statusCode === '0000') {
          ...
          ToastsStore.success(t`lanSPLabelSuccessInfoUpdated`)
          setTimeout(() => {
          }, 2000)
        } else {
          ...
          ToastsStore.error(t`lanSPLabelErrorInfoUpdateFailed`)
        }
      })
    }
  }
...
ADHostsPropertyInfoEditComponent.propTypes = {
