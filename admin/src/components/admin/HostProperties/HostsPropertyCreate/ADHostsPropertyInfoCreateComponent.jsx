...
import ADHostsPropertyInfoPriceCreateComponent from './ADHostsPropertyInfoPriceCreateComponent'
import ADHostsAmenitiesCreateComponent from './ADHostsAmenitiesCreateComponent'
import ADHostsServicesCreateComponent from './ADHostsServicesCreateComponent'
import ADHostsGuestRulesCreateComponent from './ADHostsGuestRulesCreateComponent'

import '../../css/all.min.css'
import '../../css/argon.min.css'
import '../../css/nucleo.css'

class ADHostsPropertyInfoCreateComponent extends React.Component {
  constructor (props) {
    super(props)
    ...
    this.state = {
      ...
      errorMessage: '',
      isSavedPricing: false,
      isCreatedPricing: false,
  ...
  commonFuntion (arrayData, availableData, data, type) {
    ...
    switch (type) {
      case 'price':
        this.setState({ priceObj: arrayData, isCreatedPricing: true })
        break
      case 'amenities':
  ...
  handleCreatePropertyInfo () {
    ...
    } else if (!this.state.isCreatedPricing) {
      this.setState({ errorMessage: t`lanSPLabelErrorPropertyInfoCreatePrice` })
    } else if (!this.state.isSavedPricing) {
      this.setState({ errorMessage: 'please save changes in Pricing' })
  ...
  handlePricingChange (value) {
    this.setState({ isSavedPricing: value })
  }
                ...
                <div className='accordion' id='accordionExample'>
                  ...
                  <div className='card'>
                    ...
                    <div id='collapseTwo' className='collapse' aria-labelledby='headingTwo' data-parent='#accordionExample'>
                      <div className='card-body'>
                        <ADHostsPropertyInfoPriceCreateComponent handlePricingChange={this.handlePricingChange} commonFuntion={this.commonFuntion} priceObj={this.state.priceObj} />
                      </div>
                    </div>
                  </div>
                  <div className='card'>
                    ...
                    <div id='collapseThree' className='collapse' aria-labelledby='headingThree' data-parent='#accordionExample'>
                      <div className='card-body'>
                        <ADHostsAmenitiesCreateComponent handleAmenitiesChange={this.handleAmenitiesChange} commonFuntion={this.commonFuntion}
                  ...
                  <div className='card'>
                    ...
                    <div id='collapseFour' className='collapse' aria-labelledby='headingFour' data-parent='#accordionExample'>
                      <div className='card-body'>
                        <ADHostsServicesCreateComponent handleServicesChange={this.handleServicesChange} commonFuntion={this.commonFuntion}
                  ...
                  <div className='card'>
                    ...
                    <div id='collapseFive' className='collapse' aria-labelledby='headingFive' data-parent='#accordionExample'>
                      <div className='card-body'>
                        <ADHostsGuestRulesCreateComponent handleGuestRulesChange={this.handleGuestRulesChange} commonFuntion={this.commonFuntion} guestRulesObj={this.state.guestRulesObj}
...
ADHostsPropertyInfoCreateComponent.propTypes = {
...
export default ADHostsPropertyInfoCreateComponent
