...
class ADHostsGuestRulesCreateComponent extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
...
ADHostsGuestRulesCreateComponent.propTypes = {
...
export default ADHostsGuestRulesCreateComponent
