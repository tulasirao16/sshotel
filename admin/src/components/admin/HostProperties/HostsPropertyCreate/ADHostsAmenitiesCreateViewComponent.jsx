...
class ADHostsAmenitiesCreateViewComponent extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      date: new Date(),
...
ADHostsAmenitiesCreateViewComponent.propTypes = {
...
export default ADHostsAmenitiesCreateViewComponent
