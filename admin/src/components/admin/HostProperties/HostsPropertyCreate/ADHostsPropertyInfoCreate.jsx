...
import ADHostsPropertyInfoCreateComponent from './ADHostsPropertyInfoCreateComponent'

class ADHostsPropertyInfoCreate extends React.Component {
  constructor () {
    super()
    this.state = {
...
ADHostsPropertyInfoCreate.propTypes = {
...
export default ADHostsPropertyInfoCreate
