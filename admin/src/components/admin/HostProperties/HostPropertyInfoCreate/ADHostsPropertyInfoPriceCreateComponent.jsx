...
class ADHostsPropertyInfoPriceCreateComponent extends React.Component {
  constructor (props) {
    ...
    this.state = {
      ...
      cgstAmount4: 0,
      weekEndcgstAmount: 0,
      weekEndcgstAmount1: 0,
      weekEndcgstAmount2: 0,
      weekEndcgstAmount3: 0,
      weekEndcgstAmount4: 0,
      ...
      sgstAmount4: 0,
      weekEndsgstAmount: 0,
      weekEndsgstAmount1: 0,
      weekEndsgstAmount2: 0,
      weekEndsgstAmount3: 0,
      weekEndsgstAmount4: 0,
      ...
      allowMidnight: '',
      modalIsOpen: false,
      isMidnightCheckOutAllowed:false,
...
// change
  ...
  handleAllCal () {
    ...
    // let minBasePrice2 = Math.ceil((basePrice / 4) * 2 + FirstChar1)
    // let minBasePrice3 = Math.ceil((basePrice / 4) * 3 + FirstChar1)
    let basePrice = this.state.basePrice === '' ? 1 : ''
    let weekEndBasePrice = this.state.weekEndBasePrice === '' ? 1 : ''
    let HandleBasePriceCal = this.HandleBasePriceCal(basePrice)
  ...
  handlePriceUnitValue (event) {
    ...
    if (event.target.value === '24<=>Per Day') {
      ...
      // let WEminBasePrice2 = Math.ceil((weekEndbasePrice / 4) * 2 + WEFirstChar1)
      // let WEminBasePrice3 = Math.ceil((weekEndbasePrice / 4) * 3 + WEFirstChar1)
      let WEminBasePrice = Math.ceil((weekEndbasePrice / 4) * 50)
      let WEminBasePrice2 = Math.ceil((weekEndbasePrice / 4) * 75)
      let WEminBasePrice3 = Math.ceil((weekEndbasePrice / 4) * 90)
            ...
            <div className='row'>
              ...
              <div className='col-md-3 pt-4 mt-2'>
                <input className='mt-2' type='checkbox' id='allow midnight checkout' ref={(input) => { this.textInput = input }}
                  value={this.state.allowMidnight} onChange={() => this.setState({ errorMessage: '', allowMidnight: this.state.allowMidnight === '' ? 'checked' : '', isMidnightCheckOutAllowed: this.state.isMidnightCheckOutAllowed === false ? true : false })} />
                      ...
                      <div className='card-body'>
                        {
                          this.state.isMidnightCheckOutAllowed === true
                            ? <label style={{ fontSize: 19, color: '#000' }} >Are Tou Sure Want To Allow Mid Night Checkout ?</label>
                            : <label style={{ fontSize: 19, color: '#000' }} >Are You Sure Don't Want To Allow Mid Night Checkout ?</label>
                        }
                        {/* <label style={{ fontSize: 19, color: '#000' }} >{this.state.modalIsOpen === false ? Are You Sure Don't Want To Allow Mid Night Checkout : Are Tou Sure Want To Allow Mid Night Checkout }</label> */}
                      </div>
