...
import ADHostsPropertyInfoPriceCreateComponent from '../../../../components/admin/HostProperties/HostPropertyInfoCreate/ADHostsPropertyInfoPriceCreateComponent'
import ADHostsAmenitiesCreateComponent from '../../../../components/admin/HostProperties/HostPropertyInfoCreate/ADHostsAmenitiesCreateComponent'
import ADHostsServicesCreateComponent from '../../../../components/admin/HostProperties/HostPropertyInfoCreate/ADHostsServicesCreateComponent'
import ADHostsGuestRulesCreateComponent from '../../../../components/admin/HostProperties/HostPropertyInfoCreate/ADHostsGuestRulesCreateComponent'
  ...
  handleCreatePropertyInfo () {
    ...
    if (!this.state.rentType) {
      ...
      if (this.state.createProperty === 'create') {
        ...
        let obj = {
          url: config.baseUrl + config.postADHostsPropertyInfoCreateAPI,
          body: infoObj
        }
        let _this = this
                ...
                <div className='accordion' id='accordionExample'>
                  ...
                  <div className='card'>
                    ...
                    <div id='collapseTwo' className='collapse' aria-labelledby='headingTwo' data-parent='#accordionExample'>
                      <div className='card-body'>
                        <ADHostsPropertyInfoPriceCreateComponent commonFuntion={this.commonFuntion} priceObj={this.state.priceObj} />
                      </div>
                    </div>
                  </div>
                  <div className='card'>
