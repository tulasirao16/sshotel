...
import ADHostsAminitiesViewComponent from './ADHostsAminitiesViewComponent'
...
class ADHostsAmenitiesCreateComponent extends React.Component {
  ...
  handleSearch = (event) => {
    ...
    let searchAmenities = Amenities.filter(function (item) {
      return item.name.toLowerCase().indexOf(event.target.value.toLowerCase()) > -1 || item.type.toLowerCase().indexOf(event.target.value.toLowerCase()) > -1 ||
      item.status.toLowerCase().indexOf(event.target.value.toLowerCase()) > -1
    })
  ...
  render () {
   ...
   : <ADHostsAminitiesViewComponent handleAmenitiesChange={this.props.handleAmenitiesChange} amenitiesObj={this.state.amenitiesObj}
