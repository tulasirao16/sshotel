...
import ADHostsServicesViewComponent from './ADHostsServicesViewComponent'
    ...
    return (
      <div>
        ...
        ? <div>
          ...
          : <ADHostsServicesViewComponent handleServicesChange={this.props.handleServicesChange} selectedService={this.state.selectedService} handleServiceModifiedData={this.handleServiceModifiedData} />
        }
      </div>
    )
  }
