...
class ADEUUsersCreateComponent extends React.Component {
  constructor () {
  ...
  handleCreateUser () {
    ...
    if (!this.state.firstName.trim()) {
      ...
      let _this = this
      let obj = { url: config.baseUrl + config.postADEUUserCreateAPI, body: userData }
            ...
            <div className='row'>
              ...
              <div className='col-md-3 pr-1'>
                <div className='form-group'>
                  ...
                  <input type='text' className='form-control' name='zip' maxLength='6' onKeyPress={this.handleMobileNumKeys} value={this.state.zip} onChange={() => this.setState({ zip: event.target.value, errorMessage:'' })} />
                </div>
              </div>
            </div>
            <div className='row'>
...
ADEUUsersCreateComponent.propTypes = {
  handleUserCreatedData: PropTypes.any
}
export default ADEUUsersCreateComponent
