...
import ADEUUserProfileIdProofCreateComponent from './ADEUUserProfileIdProofCreateComponent'
...
class ADEUUserProfileIdProofsListComponent extends React.Component {
  constructor () {
    super()
    this.state = {
    ...
    this.handleEditIdProof1 = this.handleEditIdProof1.bind(this)
  ...
  componentWillMount () {
    let idproofsList = {
      url: config.baseUrl + config.getADEUUserIdProofListAPI + this.state.euUserData._id
    }
    let _this = this
                ...
                <div className='card-body pl-5 pr-5'>
                  <Tabs onSelect={(index, label) => console.log(label + ' selected')}
                            ...
                            {this.state.idproofsList.map((item, i) =>
                              <tr key={i}>
                                ...
                                <td>
                                  ...
                                  <a onClick={() => this.handleEditIdProof1(item)} className='table-action table-action-edit' data-toggle='tooltip'>
                    ...
                    <Tab label={t`lanEUTitleCreateIDProof`}>
                      <ADEUUserProfileIdProofCreateComponent toastFunc={this.props.toastFunc} handleIdProofCreate={this.handleIdProofCreated} />
                    </Tab>
                  </Tabs>
                </div>
              </div>
...
ADEUUserProfileIdProofsListComponent.propTypes = {
  handleEditIdProof: PropTypes.any,
  toastFunc: PropTypes.any
}

export default ADEUUserProfileIdProofsListComponent
