...
var euUserSchema = new Schema({
    ...
    mobileNumber: {type: String, required: true, set: CommonService.encrypt, get: CommonService.decrypt, unique: true, trim: true},
    alternateContactNumber: {type: String, required: false, set: CommonService.encrypt, trim: true},
    ...
    alternateEmail: {type: String, required: false, set: CommonService.encrypt, trim: true},
    ...
    signupType: {type: String, required: true, index: true, trim: true}, // Local, Google, Facebook
    signupUserId: {type: String, index: true, trim: true, default: uuid.v1}, // Local, Google, Facebook - Record ID
    preferences: {
        ...
        favouriteProperties: [{type: String, required: false, trim: true}] // Property IDs
    },
...
module.exports = mongoose.model(config.collectionEndUserUsers, euUserSchema);
