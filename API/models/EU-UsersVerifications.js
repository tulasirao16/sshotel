...
var euUsersVerificationsSchema = new Schema({
    ...
    verifyType: {type: String, required: true, trim: true}, // Mobile, Email
    verifySign: {type: String, set: CommonService.rsaHashAndSign, required: true, unique: true, trim: true},
    verifyValue: {type: String, set: CommonService.rsaEncrypt, get: CommonService.rsaDecrypt, required: true, unique: true, trim: true},
...
module.exports = mongoose.model(config.collectionEndUserUsersVerifications, euUsersVerificationsSchema);
