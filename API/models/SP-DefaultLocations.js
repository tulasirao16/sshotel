...
// Define schema for 'Service Provider - DefaultLocations' model
var spDefaultLocationsSchema = new Schema({
...
spDefaultLocationsSchema.index({'$**': 'text'});

module.exports = mongoose.model(config.collectionSPDefaultLocations, spDefaultLocationsSchema);
