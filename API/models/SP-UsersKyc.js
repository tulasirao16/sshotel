...
// Define schema for 'Service Provider - UsersKyc' model
var spUsersKycSchema = new Schema({
    ...
    spUserId: {type: String, required: true, index: true, ref: config.collectionSPUsers},
...
spUsersKycSchema.index({'$**': 'text'});

module.exports = mongoose.model(config.collectionSPUsersKyc, spUsersKycSchema);
