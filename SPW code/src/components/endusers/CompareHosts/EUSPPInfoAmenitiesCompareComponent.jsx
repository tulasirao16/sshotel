...
class EUSPPInfoAmenitiesCompareComponent extends React.Component {
  constructor () {
    super()
    this.state = {
      allAmenities: [],
  ...
  handleBack () {
    if (this.state.conditionValue === 'homeScreen') {
                      ...
                      <div className='col-lg-3 col-sm-3 col-xs-12 text-center' key={i}>
                        <div className='host-box'>
                          <p className='card-category'>
                            ...
                            <span className='close-host pl-3'><a onClick={() => this.handleRemove(item)}><i className='fas fa-times' /></a></span></p>
                        </div>
                      </div>
                    )}
                  </div>
                          ...
                          <tr key={i}>
                            <td scope='row'>
                              <div className='compare-img'>
                                <img src={item && item.amenityIconPath ? config.baseUrl + item.amenityIconPath : require('../../../../assets/compare/icon8.png')} className='img-fluid img-rounded' />
                              </div>
                            </td>
                        ...
                        <td>
                          <div className='row'>
                            <div className='col-sm-12 text-center' >
                              <a className='btn btn-danger text-white px-4 btn-round' onClick={this.handleBack}>{t`lanCommonButtonBack`}</a>
                            </div>
                          </div>
                        </td>
...
export default EUSPPInfoAmenitiesCompareComponent
