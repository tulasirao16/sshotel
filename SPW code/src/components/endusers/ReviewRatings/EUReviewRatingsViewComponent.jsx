...
class EUReviewRatingsViewComponent extends React.Component {
  ...
  componentWillMount () {
    ...
    this.setState({
      ...
      propertyTitle: reviewRatingObj.spPropertyInfoId ? reviewRatingObj.spPropertyInfoId.propertyTitle : '',
                            ...
                            <li className='list-group-item-one py-1'>
                              <div className='row align-items-center'>
                                ...
                                <div className='col-lg-8'>
                                  <h5 className='mb-1 text-sm'>{this.state.propertyTitle},{this.state.area}</h5>
                                </div>
                              </div>
                            </li>
                            <li className='list-group-item-one py-1'>
