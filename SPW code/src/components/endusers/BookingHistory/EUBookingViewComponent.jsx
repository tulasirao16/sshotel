                  ...
                  <div className='col-lg-6 col-7'>
                    <nav aria-label='breadcrumb eu' className='d-md-inline-block ml-md-4'>
                      <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                        ...
                        <li className='breadcrumb-item'><a onClick={this.handleViewClose} >{t`lanCommonTitleBookings`}</a></li>
                        ...
                        <div className='col-md-12 col-lg-12 col-sm-12 col-xl-12'>
                          <div className='row'>
                            <div className='col-sm-6'>
                              ...
                              <div className='row py-2'>
                                <div className='col-sm-3 col-5'><small>{t`lanCommonLabelName`}</small></div>
                                <div className='col-sm-6 col-7'><h5 className='mb-0 text-sm'>{this.state.bookingData.euName}</h5></div>
                              </div>
                              <div className='row py-2'>
                                <div className='col-sm-3 col-5'><small>{t`lanCommonLabelCheckIn`}</small></div>
                                <div className='col-sm-6 col-7'><h5 className='mb-0 text-sm'>{moment(this.state.bookingData.checkInDate).format('MMM DD, YY') + ' (' + moment(this.state.bookingData.checkInDate).format('hh:mm A') + ')'}</h5></div>
                              </div>
                              {this.state.bookingData.bookingType === 'Hours'
                                ? <div className='row py-2' >
                                  <div className='col-sm-3 col-5'><small>{t`lanSPLabelTotalDays`}/Hrs</small></div>
                                  <div className='col-sm-6 col-7'><h5 className='mb-0 text-sm'>
                                    {`${this.state.bookingData.totalDays} day(s) / ${this.state.bookingData.totalHours} hour(s)`}
                                  </h5></div>
                                </div>
                                : <div className='row py-2'>
                                  <div className='col-sm-3 col-5'><small>{t`lanSPLabelTotalDays`}</small></div>
                                  <div className='col-sm-6 col-7'><h5 className='mb-0 text-sm'>{this.state.bookingData.totalDays}</h5></div>
                                </div>
                                }
                              <div className='row py-2'>
                                <div className='col-sm-3 col-5'><small>{t`lanEULabelGuests`}</small></div>
                                <div className='col-sm-6 col-7'><h5 className='mb-0 text-sm'>{this.state.bookingData.noOfAdults} {t`lanEULabelAdults`}, {this.state.bookingData.noOfChilds} {t`lanEULabelChilds`}</h5></div>
                              </div>
                            </div>
                            <div className='col-sm-6'>
                              <div className='row py-2'>
                                <div className='col-sm-3 col-5'><small>{t`lanCommonLabelStatus`}</small></div>
                                <div className='col-sm-6 col-7'><h5 className='mb-0 text-sm'>{this.state.bookingData.bookingStatus}</h5></div>
                              </div>
                              <div className='row py-2'>
                                <div className='col-sm-3 col-5'><small>{t`lanEULabelHotel`} {t`lanCommonLabelName`}</small></div>
                                <div className='col-sm-6 col-7'><h5 className='mb-0 text-sm'>{this.state.bookingData.spPropertyTitle}</h5></div>
                              </div>
                              <div className='row py-2'>
                                <div className='col-sm-3 col-5'><small>{t`lanCommonLabelCheckOut`}</small></div>
                                <div className='col-sm-6 col-7'><h5 className='mb-0 text-sm'>{moment(this.state.bookingData.checkOutDate).format('MMM DD, YY') + ' (' + moment(this.state.bookingData.checkOutDate).format('hh:mm A') + ')'}</h5></div>
                              </div>
                              <div className='row py-2'>
                                <div className='col-sm-3 col-5'><small>{t`lanCommonLabelBookingAmount`}</small></div>
                                <div className='col-sm-6 col-7'><h5 className='mb-0 text-sm'>{this.state.bookingData.totalPrice}</h5></div>
                              </div>
                              <div className='row py-2'>
                                <div className='col-sm-3 col-5'><small>{t`lanEULabelRooms`}</small></div>
                                <div className='col-sm-6 col-7'><h5 className='mb-0 text-sm'>{this.state.bookingData.noOfRooms}</h5></div>
                              </div>
                            </div>
                          </div>
                        </div>
