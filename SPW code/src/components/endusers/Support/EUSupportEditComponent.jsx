        ...
        <div className='card'>
          ...
          <div className='edit-profile-form'>
            <div className='card-body'>
              <div className='card-body px-1 card-ticket'>
                ...
                <div className=' row'>
                  <div className='col-sm-12 text-center' >
                    ...
                    <button className='btn btn-primary update-edit btn-text-white' disabled={this.state.submitDisabled} onClick={this.handleUpdate}>{t`lanCommonButtonUpdate`}</button>
                  </div>
                </div>
              </div>
            </div>
