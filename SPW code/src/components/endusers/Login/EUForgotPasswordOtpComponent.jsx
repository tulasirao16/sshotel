                  ...
                  <form role='form'>
                    ...
                    <div className='px-lg-6 py-lg-3'>
                      <div className='text-center mb-3'>
                        <div className='h4 font-weight-300'>{t`lanEUCommonLabelEnterOtp`}</div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className='text-center'>
                        <button type='button' ref='otpNumberSubmit' className='btn btn-primary mt-2' disabled={this.state.doneDisabled} onClick={this.handleOtpDone}>{t`lanCommonButtonDone`}</button>
                      </div>
                    </div>
