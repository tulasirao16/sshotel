                              ...
                              <div className='room-inner'>
                                <div className='room'>
                                  ...
                                  <div className='caption'>
                                    ...
                                    <div className='txt4'>
                                      <a onClick={this.handleAllHotelsList}>{t`lanEUButtonViewDetail`}<i className='fa fa-caret-right' aria-hidden='true' /></a>
                                    </div>
                                  </div>
                                  <div className='select-txt'>
                                    <a href='details.html'><span>{t`lanEUButtonSelectThisRoom`}<i className='fa fa-angle-right' aria-hidden='true' /></span></a>
                                  </div>
                                  <div className='room-icons'>
                                    ...
                                    <div className='room-price'>
                                      ...
                                      <div className='txt2 perNight'>{t`lanEUButtonPerNight`}</div>
                                    </div>
                                  </div>
                                </div>
                              </div>
        ...
        >
          <div className='container'>
            ...
            <div className='col-sm-12 hotel-names-compare'>
              <p className='pb-0'>{t`lanCommonLabelYouCanCompareUpToThreeHotels`} </p>
