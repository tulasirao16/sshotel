                    ...
                    <div className='row '>
                      {/* <div className='col-lg-6 mb-4 p-7'>
                        <div className=' bg-transparent pb-3'>
                          <h5 className='card-title'>Cozy Spaces</h5>
                        </div>
                        ...
                        <div className='row'>
                          <div className='col-sm-10 text-left'>
                            <div className='form-group'>
                              <label className='form-control-label '>{t`lanEULabelFirstName`}*</label>
                          ...
                          <div className='col-md-10 text-left'>
                            <div className='form-group'>
                              <label className='form-control-label'>{t`lanEULabelLastName`}*</label>
                          ...
                          <div className='col-md-10 col-lg-10 text-left'>
                            <div className='form-group'>
                              <label className='form-control-label'>{t`lanEULabelDateOfBirth`}*</label><br />
                              {/* <DatePicker
                          ...
                          <div className='col-md-10 col-lg-10 text-left '>
                            <div className='form-group'>
                              <label className='form-control-label' >{t`lanEULabelAddress`}*</label>
                          ...
                          <div className='row px-2'>
                            <div className='col-lg-9 col-sm-9'>
                              <div className='text-left mb-4 mt-2'>
                                <span className='text-muted'><small>{t`lanEULabelDoYouHaveAnAccount`} </small> <a style={{ color: '#01a4a2' }} onClick={this.handleEndUserLogin} className='text-underline'> {t`lanEULabelLogin`}</a></span>
