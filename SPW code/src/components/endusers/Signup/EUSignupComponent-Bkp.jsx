...
class EUSignupComponent extends React.Component {
  ...
  handleSpVerify (event) {
    if (!this.state.fName) {
      this.setState({ fError: t`lanEULabelErrorPleaseProvideFirstName`, fSuccess: false })
    } else if (!this.state.lName) {
      this.setState({ lError: t`lanEULabelErrorPleaseProvideLastName`, lSuccess: false })
    } else if (!this.state.dob) {
      this.setState({ dobError: t`lanEULabelErrorPleaseProvideDateOfBirth`, dobSuccess: false })
    } else if (!this.state.address) {
      this.setState({ aError: t`lanEULabelErrorPleaseProvideAddress`, aSuccess: false })
    } else {
                        ...
                        <div className='row '>
                          <div className='col-sm-12 text-left'>
                            <div className='form-group'>
                              <label className='form-control-label '>{t`lanEULabelFirstName`} <span className='error'>*</span></label>
                          ...
                          <div className='col-md-12 text-left'>
                            <div className='form-group'>
                              <label className='form-control-label'>{t`lanEULabelLastName`}<span className='error'>*</span></label>
                          ...
                          <div className='col-md-12 col-lg-12 text-left'>
                            <div className='form-group'>
                              <label className='form-control-label'>{t`lanEULabelDateOfBirth`} <span className='error'>*</span></label><br />
                              <DayPickerInput
                          ...
                          <div className='col-md-12 col-lg-12 text-left '>
                            <div className='form-group'>
                              <label className='form-control-label' >{t`lanEULabelAddress`} <span className='error'>*</span></label>
                          ...
                          <div className='col-lg-12 col-sm-12 text-right'>
                            ...
                            <div className='text-right mt-2'>
                              <span className='text-muted text-sm'><small>{t`lanEULabelDoYouHaveAnAccount`} </small> <a style={{ color: '#01a4a2' }} onClick={this.handleEndUserLogin} className='text-underline'> {t`lanEULabelLogin`}</a></span>
