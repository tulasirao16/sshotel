                  ...
                  <form role='form'>
                    ...
                    <div>
                      <div className='text-center'>
                        ...
                        <button type='button' className='btn btn-primary mt-2' ref='mobileOtpNumSubmit' disabled={this.state.submitDisabled} onClick={this.handleSubmit}>{ t`lanCommonButtonDone` }</button>
                      </div>
                    </div>
