    ...
    fetch(config.googleGeoLocationLatLng + lat + ',' + long + '&key=' + config.googleMapsAPIKey)
      ...
      .then((responseJson) => {
        ...
        if (area && city && state) {
          ...
          this.setState({ location: area + ', ' + city + ', ' + state, latitude: lat, longitude: long, locationSearchObj: locationSearchObj })
                  ...
                  <div className='col-sm-12 text-center'>
                    <div className='hourly-div' >
                      <a onClick={this.handleHostsBy}>
                        <p className='p-hourly-book-title'>Hourly Booking</p>
                      </a>
                    </div>
                  </div>
                </div>
                      ...
                      <div className='col-lg-9 col-xs-12 both-list m-auto pl-4 section-list' >
                        <div className='row bg-light py-4'>
                          ...
                          ? this.state.nearestSPPropertyList.map((item, i) =>
                            <EUHotelsEachRowListComponent data={item} key={i} SPPropertyList={this.state.nearestSPPropertyList} authObj={this.state.authObj}
                                      ...
                                      <div className='room-price'>
                                        <div className='row'>
                                          <div className='col-md-4 pr-0 pl-0'>
                                            <div className='txt1'><p> ₹ <span>{this.state.selectedHotelData.pricing.weekEndTotalPrice}</span></p></div>
                                          </div>
                                          <div className='col-md-8'>
                                            {this.state.selectedHotelData.pricing.weekEndBasePriceDiscount !== '0'
                                              ? <div className='row'>
                                                <div className='col-md-7 pr-0 pl-0'>
                                                  <div className='txt3'><del>₹{this.state.selectedHotelData.pricing.weekEndWdTotalPrice}</del></div></div>
                                      ...
                                      <div className='room-price'>
                                        <div className='row'>
                                          ...
                                          <div className='col-md-8'>
                                            ...
                                            ? <div className='row'>
                                              <div className='col-md-7 pr-0 pl-0'>
                                                <div className='txt1'><del>₹ {this.state.selectedHotelData.pricing.wdTotalPrice}</del></div></div>
                                              <div className='col-md-3 pl-0 pr-0'>
                                                <div className='txt2'>
                      ...
                      <div className='col-lg-9 col-xs-12 both-list m-auto pl-4 section-list' >
                        ...
                        <div className='row bg-light pt-2 pb-4'>
                          <div className='col-sm-12 text-center mb-2'>
                            ...
                            ? <div className='hourly-div'>
                              <a onClick={this.handleHostsBy}>
                                <p className='p-hourly-book-title'>{t`lanEULabelGoWithHourlyBooking`}</p>
                              </a>
                            </div>
                            : <div className='hourly-div'>
                              <a onClick={this.handleHostsBy}>
                                <p className='p-hourly-book-title'>{t`lanEULabelGoWithDailyBooking`}</p>
                              </a>
                            </div>
                            }
                          </div>
