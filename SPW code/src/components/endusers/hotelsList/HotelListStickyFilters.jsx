            ...
            <div className='row'>
              ...
              <div className='col-lg-2 col-sm-2 col-xs-12 filter-tab-sorting-view'>
                <button className='btn btn-icon btn-primary sorting-btn' type='button' onClick={this.openModal}>
                  ...
                  <span className='btn-inner--text'>{t`lanEUButtonSorting`}</span>
                </button>
              </div>
              {/* sorting ends */}
              {/* Modal filter starts */}
              ...
              <div className='col-md-12 col-sm-12 col-xs-12 sub-menu mb-xl-0 mb-4'>
                <div className='row'>
                  <div className='col-lg-3 col-sm-3 col-xs-12'>
                    <label>{t`lanEULabelBedRooms`}</label>
                  ...
                  <div className='col-lg-3 col-sm-3 col-xs-12'>
                    <label>{t`lanEULabelBathRooms`}</label>
                    <select className='form-control'>
                      <option>1</option>
                      <option>2</option>
                      <option>3</option>
                  ...
                  <div className='col-lg-3 col-sm-3 col-xs-12'>
                    <label>{t`lanEULabelRoomType`}</label>
                    <select className='form-control'>
                ...
                <div className='row'>
                  <div className='col-sm-6 col-lg-3 col-xs-12 '>
                    <div className='custom-control custom-checkbox'>
                      ...
                      <label className='custom-control-label' htmlFor='customCheck1'>{t`lanEULabelInstantBooking`}</label>
                    </div>
                  </div>
                  <div className='col-sm-6 col-lg-3 col-xs-12'>
                    <div className='custom-control custom-checkbox'>
                      <input type='checkbox' className='custom-control-input' id='customCheck1' />
                      <label className='custom-control-label' htmlFor='customCheck1'>{t`lanEULabelSuperHost`}</label>
                    </div>
                  </div>
                </div>
                <hr />
                <div className='aminities'>
                  <div className='row '>
                    <div className='col-sm-12'>
                      <label>{t`lanEULabelAmenities`}</label>
                    </div>
                ...
                <div className='services'>
                  <div className='row '>
                    <div className='col-sm-12'>
                      <label>{t`lanEULabelServices`}</label>
                    </div>
                    ...
                    ) : <div className='col-lg-12, col-xs-12 col-sm-12 text-center'>{t`lanEULabelNoServicesAvailable`}</div>}
                    <div className='col-sm-12 pt-2 filter-more'>
                      <a className=' more-trigger' data-more='More' data-less='Less'>
                        <i className='far fa-arrow-alt-circle-down' />
                      </a>
                ...
                <div className='rules'>
                  <div className='row '>
                    <div className='col-sm-12'>
                      <label>{t`lanEULabelGuestRules`}</label>
                    </div>
                    ...
                    ) : <div className='col-lg-12, col-xs-12 col-sm-12 text-center'>{t`lanEULabelNoGuestRules`} </div>}
                    <div className='col-sm-12 pt-2 filter-more'>
                      <a className=' more-trigger' data-more='More' data-less='Less'>
                        <i className='far fa-arrow-alt-circle-down' />
                      </a>
                ...
                <div className='languages'>
                  <div className='row '>
                    <div className='col-sm-12'>
                      <label>{t`lanEULabelLanguages`}</label>
                    </div>
                    ...
                    ) : <div className='col-lg-12, col-xs-12 col-sm-12 text-center'>{t`lanEULabelNoData`} </div>}
                    <div className='col-sm-12 pt-2 filter-more'>
                      <a className=' more-trigger' data-more='More' data-less='Less'>
                        <i className='far fa-arrow-alt-circle-down' />
                      </a>
                ...
                <div className='row modal-btns' >
                  <button onClick={this.closeModal} className='btn btn-danger' type='button' >{t`lanEUButtonCancel`}</button>
                  <button className='btn btn-success' type='button' >{t`lanEUButtonApply`}</button>
                </div>
              </div>
            </div>
          </div>
