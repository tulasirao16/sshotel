...
class EndUsersLogin extends React.Component {
  ...
  handleSubmit (event) {
    ...
    if (!this.state.userID) {
      this.setState({ errorMessage: t`lanEULabelErrorUserIDIsRequired` })
    } else if (!this.state.password) {
      this.setState({ errorMessage:  t`lanEULabelErrorPasswordIsRequired` })
    } else {
                        ...
                        <div className='card-group'>
                          <div className='card'>
                            <div className='card-body'>
                              <h3 className='text-center'>{t`lanEULabelLogin`}</h3>
