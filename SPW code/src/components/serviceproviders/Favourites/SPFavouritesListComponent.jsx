...
class SPFavouritesListComponent extends React.Component {
  ...
  handlePageChange (pageNumber) {
    if (this.state.activePage !== pageNumber) {
      ...
      let favouritesList = {
        unBlockStatus: true,
        url: config.baseUrl + config.getSPFavouritesListAPI + pageNumber + '/' + this.state.searchString }
      let _this = this
      APICallManager.getCall(favouritesList, function (resObj) {
        if (resObj.data.statusCode === '0000') {
          _this.setState({
                  ...
                  <div className='col-lg-6 col-7'>
                    ...
                    <nav aria-label='breadcrumb' className='d-none d-md-inline-block ml-md-4'>
                      <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                        ...
                        <li className='breadcrumb-item active' aria-current='page'><a onClick={() => this.handleBack()} >{t`lanSPLabelFavouritesListPage`} </a></li>
                        {this.state.isFavouriteView ? <li className='breadcrumb-item active' aria-current='page'><a >{t`lanSPLabelFavouriteView`} </a></li> : ''}
                      </ol>
                    </nav>
                  </div>
