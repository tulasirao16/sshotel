...
class SPPropertyInfoPriceCreateComponent extends React.Component {
  constructor (props) {
    ...
    let isMinBaseDefaultInfocreate = localStorage.getItem('isMinBaseDefaultInfocreate')
    ...
    this.state = {
      ...
      appPercentage: authObj && authObj.spServiceProviderId.appPercentage ? authObj.spServiceProviderId.appPercentage : 2,
      ...
      // isDefaultMinBasePrice: this.props.isCreateProperty === 'create' ? true : minBasecheck === true ? true : isMinBaseDefaultInfocreate === 'true' ? true : false,

      isCreateProperty: this.props.isCreateProperty === 'create' ? true : minBasecheck === true ? true : isMinBaseDefaultInfocreate === 'true' ? true : false,
      isDefaultBasePrice: data && data.isDefaultBasePrice ? data.isDefaultBasePrice : this.props.isCreateProperty === 'create' ? true : minBasecheck === 'true' ? true : isMinBaseDefaultInfocreate === 'true' ? true : false,
      isDefaultMinBasePrice: data && data.isDefaultMinBasePrice ? data.isDefaultMinBasePrice : this.props.isCreateProperty === 'create' ? true : minBasecheck === 'true' ? true : false,
      allowMidnight: '',
      modalIsOpen: false,
      isMidnightCheckOutAllowed: data && data.isMidnightCheckOutAllowed ? data.isMidnightCheckOutAllowed === true ? true : false : false,
      // isMidnightCheckOutAllowed: data && data.isMidnightCheckOutAllowed ? data.isMidnightCheckOutAllowed === true ? 'checked' : '' : false,
...
// change
  ...
  handlePriceUnitValue (event) {
    ...
    if (event.target.value === '24<=>Per Day') {
      ...
      let minBasecheck = localStorage.getItem('isMinBaseDefault')
      if (this.props.isCreateProperty === 'create') {
        this.setState({ isDefaultMinBasePrice: true })
      } else {
        if (minBasecheck === 'true') {
  ...
  closeModal () {
    ...
    this.setState({ modalIsOpen: !this.state.modalIsOpen })
    ToastsStore.success(t`lanSPLabelSuccessInfoPriceCreated`)
  }
  // <input type='checkbox' onChange={() => this.setState({
  //   businessChecked: this.state.businessChecked === 'checked' ? ''
  //     : 'checked'
  // })} checked={this.state.businessChecked} />Business</a>
  render () {
    return (
      <div>
        <div className='create-price'>
          <form>
                  ...
                  <div className='col-md-4'>
                    <div className='form-group'>
                      <select className='form-control' id='exampleFormControlSelect1' value={this.state.checkInHour}
                        disabled={!this.state.editVisiblePrice} onChange={(event) => this.setState({ checkInHour: event.target.value, errorMessage: '' })}>
                  ...
                  <div className='col-md-4'>
                    <div className='form-group'>
                      <select className='form-control' id='exampleFormControlSelect1' value={this.state.checkInMin}
                        disabled={!this.state.editVisiblePrice} onChange={(event) => this.setState({ checkInMin: event.target.value, errorMessage: '' })}>
                  ...
                  <div className='col-md-4'>
                    <div className='form-group'>
                      <select className='form-control' id='exampleFormControlSelect1' value={this.state.checkInAM}
                        disabled={!this.state.editVisiblePrice} onChange={(event) => this.setState({ checkInAM: event.target.value, errorMessage: '' })}>
                  ...
                  <div className='col-md-4'>
                    <div className='form-group'>
                      <select className='form-control' id='exampleFormControlSelect1' value={this.state.checkOutHour}
                        disabled={!this.state.editVisiblePrice} onChange={(event) => this.setState({ checkOutHour: event.target.value, errorMessage: '' })}>
                        {this.state.timeHours.map((timehour, i) => <option value={timehour} key={i}>{timehour}</option>)}
                      </select>
                    </div>
                  </div>
                  <div className='col-md-4'>
                    <div className='form-group'>
                      <select className='form-control' id='exampleFormControlSelect1' value={this.state.checkOutMin}
                        disabled={!this.state.editVisiblePrice} onChange={(event) => this.setState({ checkOutMin: event.target.value, errorMessage: '' })}>
                        {this.state.timeMins.map((timemin, i) => <option value={timemin} key={i}>{timemin}</option>)}
                      </select>
                    </div>
                  </div>
                  <div className='col-md-4'>
                    <div className='form-group'>
                      <select className='form-control' id='exampleFormControlSelect1' value={this.state.checkOutAM}
                        disabled={!this.state.editVisiblePrice} onChange={(event) => this.setState({ checkOutAM: event.target.value, errorMessage: '' })}>
                        {this.state.timePeriod.map((timep, i) => <option value={timep} key={i}>{timep}</option>)}
                      </select>
                    </div>
                  </div>
            ...
            <div className='row'>
              <div className='col-md-3'>
                <div className='form-group'>
                  <label className='form-control-label'>{t`lanSPLabelFullRefundCancelTime`} {t`lanCommonLabelHours`}<span className='require'>*</span></label>
              ...
              <div className='col-md-3'>
                <div className='form-group'>
                  <label className='form-control-label'>{t`lanSPLabelRefundCancelTime`} {t`lanCommonLabelHours`}<span className='require'>*</span></label>
                  <input type='text' className='form-control' id='example3cols3Input'
            ...
            <div className='row'>
              ...
              <div className='col-md-3'>
                <div className='form-group'>
                  ...
                  <select className='form-control' id='exampleFormControlSelect1' value={this.state.isDefaultBasePrice}
                    disabled={this.props.isCreateProperty === 'create'}
              ...
              <div className='col-md-3'>
                <div className='form-group'>
                  ...
                  <select className='form-control' id='exampleFormControlSelect1' value={this.state.isDefaultMinBasePrice}
                    ...
                    disabled={this.props.isCreateProperty === 'create' ? true : this.state.checkDefaultBillingType === false ? true : this.state.editVisiblePrice === true ? true : this.state.checkDefaultMinBase ? false : true}
              ...
              <div className='col-md-3 pt-4 mt-2'>
                <input className='mt-2' type='checkbox' id='allow midnight checkout' ref={(input) => { this.textInput = input }}
                  ...
                  onChange={() => this.setState({ errorMessage: '', allowMidnight: this.state.allowMidnight === '' ? 'checked' : '', isMidnightCheckOutAllowed: !this.state.isMidnightCheckOutAllowed })} />
                      ...
                      <div className='card-body'>
                        {
                          this.state.isMidnightCheckOutAllowed === true
                            ? <label style={{ fontSize: 19, color: '#000' }} >{t`lanCommonLabelAreYouSureWantToAllowMidNightCheckout`}</label>
                            : <label style={{ fontSize: 19, color: '#000' }} >{t`lanCommonLabelAreYouSureDontWantToAllowMidNightCheckout`}</label>
                        }
...
SPPropertyInfoPriceCreateComponent.propTypes = {
  ...
  isCreateProperty: PropTypes.any,
  handlePricingChange: PropTypes.func
}
