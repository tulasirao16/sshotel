        ...
        APICallManager.postCall(obj, function (resObj) {
          if (resObj.data.statusCode === '0000') {
           // _this.props.handleReplay(resObj.data.statusResult)
            ...
            _this.setState({ errorMessage: 'lanSPLabelErrorSendMessageFailed' })
          }
        })
      } else {
        let postdata = {
                ...
                <div className='col-lg-6 col-7'>
                  ...
                  <nav aria-label='breadcrumb' className='d-none d-md-inline-block ml-md-4'>
                    <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                      ...
                      <li className='breadcrumb-item'><a >{ t`lanSPLabelInbox` }</a></li>
                      <li className='breadcrumb-item'><a onClick={() => this.props.handleReplay(this.state.messagesData)} >{ t`lanSPLabelReadMessage` }</a></li>
                      <li className='breadcrumb-item active' aria-current='page'>{ t`lanSPLabelReply` }</li>
                    </ol>
                  </nav>
                </div>
              </div>
