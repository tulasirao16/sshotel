...
class SPBlockedDatesPropertyCreateComponent extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
  ...
  handleCreateBlockedDates () {
    if (this.state.blockingType === 'Continuous Blocking' && !this.state.from) {
      ...
      ToastsStore.success(t`lanSPSuccessBlockedDatesCreated`)
            ...
            <div className='col-lg-8'>
              <div className='mt-4'>
                ...
                ? <div className='row'>
                  ...
                  {t`lanSPLabelBlockDatesSelected`} {' '} {t`lanSPLabelBlockDatesFrom`} <span className='error mx-3 px-3 block-from'>{from &&
                    to &&
...
SPBlockedDatesPropertyCreateComponent.propTypes = {
  commonFunction: PropTypes.any,
  blockedDatesObj: PropTypes.any
}

export default SPBlockedDatesPropertyCreateComponent
