...
class SPBlockedDatesListComponent extends React.Component {
  ...
  componentWillMount () {
    ...
    let obj = {
      unBlockStatus: true,
      url: config.baseUrl + config.getSPPropertyBlockedDatesListAPI + this.props.propertyID }
    let obj1 = {
      unBlockStatus: true,
      url: config.baseUrl + config.getSPPropertyBlockedDatesPastListAPI + this.props.propertyID }
    let _this = this
