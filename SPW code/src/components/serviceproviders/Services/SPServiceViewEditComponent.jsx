...
class SPServiceViewEditComponent extends React.Component {
  constructor (props) {
    super(props)
  ...
  handleUpdateService () {
    ...
    if (this.state.serviceStatus === this.state.serviceData.serviceStatus && this.state.serviceType === this.state.serviceData.serviceType && this.state.serviceCharge === this.state.serviceData.serviceCharge) {
      ...
      let _this = this
      let obj = { url: config.baseUrl + config.putSPPropertyInfoServicesEditAPI, body: serviceData }
              ...
              <div className='cardbody'>
                ...
                <div className='row'>
                  <div className='col-sm-12 text-center'>
                    ...
                    <button className='btn btn btn-default' onClick={this.handleServiceBack}>{t`lanCommonButtonBack`}</button>
                  </div>
                </div>
              </div>
            </section>
            ...
            <div className='header-body'>
              <div className='row align-items-center py-4'>
                <div className='col-lg-6 col-7'>
                  <h6 className='h2 text-white d-inline-block mb-0'>{t`lanSPTitleViewService`}</h6>
                </div>
...
SPServiceViewEditComponent.propTypes = {
  selectedService: PropTypes.any,
  handleServiceModifiedData: PropTypes.any
}

export default SPServiceViewEditComponent
