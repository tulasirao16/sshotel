...
import SPServicesCreateViewComponent from './SPServicesCreateViewComponent'
...
class SPServicesCreateComponent extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      searchString: '',
  ...
  handleServiceCreate () {
    ...
    ToastsStore.success(t`lanSPLabelServicesCreatedsuccessfully`)
    ...
    return (
      <div>
        ...
        ? <div>
          ...
          : <SPServicesCreateViewComponent handleServicesChange={this.props.handleServicesChange} selectedService={this.state.selectedService} handleServiceModifiedData={this.handleServiceModifiedData} />
        }
      </div>
    )
  }
}
SPServicesCreateComponent.propTypes = {
  commonFuntion: PropTypes.any,
  serviceObj: PropTypes.any,
  availableServices: PropTypes.any,
  handleServicesChange: PropTypes.any
}
export default SPServicesCreateComponent
