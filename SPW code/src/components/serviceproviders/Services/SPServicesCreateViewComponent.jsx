      ...
      <div >
        <div>
          <div className='table-user mb-3'>
            ...
            <a><strong>{(this.state.serviceData && this.state.serviceData.serviceName) ? this.state.serviceData.serviceName : ''}</strong></a>
          </div>
          <div>
              ...
              <div className='row'>
                ...
                <div className='col-md-3'>
                  <div className='form-group'>
                    ...
                    <input type='text' disabled={this.state.serviceType === 'Free'} value={this.state.serviceCharge} onChange={this.handleServiceCharge}
