...
class SPBookingsViewComponent extends React.Component {
  constructor (props) {
    ...
    this.state = {
      ...
      bookingData: {},
      BookingViewFrom: localStorage.getItem('BookingViewFrom', 'Bookings Page')
    }
  ...
  componentWillMount () {
    if (this.state.recordId) {
      let obj = {
        unBlockStatus: true,
        url: config.baseUrl + config.getSPBookingDataAPI + this.state.recordId }
      let _this = this
  ...
  componentWillUnmount () {
    localStorage.removeItem('BookingViewFrom', 'Bookings Page')
  }
  ...
  handleBack () {
    if (this.state.BookingViewFrom === 'Bookings Page') {
                ...
                <div className='col-md-6 col-12'>
                  ...
                  <nav aria-label='breadcrumb' className='d-md-inline-block ml-md-4'>
                    <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                      ...
                      {this.state.BookingViewFrom === 'Bookings Page'
                            ...
                            <ul className='list-group list-group-flush list my--3'>
                              ...
                              <li className='list-group-item px-0'>
                                <div className='row align-items-center'>
                                  ...
                                  : <div className='col-md-3 col-6'>
                                    <small className='view-title'>{t`lanSPLabelNoOfDaysHours`}</small>
                                    <h5 className='mb-0'>{this.state.bookingData.totalDays} Day(s) / {this.state.bookingData.totalHours} Hour(s)</h5>
                                  </div>}
                                  <div className='col-md-3 col-6'>
