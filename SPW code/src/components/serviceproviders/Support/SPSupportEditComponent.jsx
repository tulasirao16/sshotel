      ...
      if (isUpdate) {
        ...
        APICallManager.putCall(obj, function (resObj) {
          if (resObj.data.statusCode === '0000') {
            ...
            ToastsStore.error('Ticket Update failed')
                ...
                <div className='card-body'>
                  <section className='notifications'>
                    <div className='row py-2'>
                      <small className='edit-title col-sm-2' >{t`lanSPLabelTicketType`}</small>
                    ...
                    <div className='row clearfix'>
                      <div className='col-md-12 col-lg-12 col-xl-12'>
                        ...
                        <div className='list-group list-group-flush'>
                          <form>
                            <div className='row'>
                              <small className='mb-2 edit-title col-sm-2'>{t`lanSPLabelTicketDescription`}</small>
                            ...
                            <div className='row'>
                              <div className='col-sm-12 text-center'>
                                <button disabled={this.state.buttonDisabled} className='btn btn-primary update-edit' onClick={this.handleUpdate}>{t`lanCommonButtonUpdate`}</button>
