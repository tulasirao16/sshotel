...
class SPPropertyNearestAreasCreate extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      area: '',
  ...
  handleAddArea () {
    ...
    if (!this.state.area) {
      ...
      let upperCaseArea = this.state.area
            ...
            <div>
              <div className='card'>
                <div className='card-header'>
                  <h3 className='mb-0'>{t`lanSPSubTitleAddNearestAreas`}</h3>
                </div>
...
SPPropertyNearestAreasCreate.propTypes = {
  commonFunction: PropTypes.any,
  nearestAreas: PropTypes.any,
  spLocationObj: PropTypes.any
}

export default SPPropertyNearestAreasCreate
