      ...
      (position) => {
        ...
        this.getLocation(position.coords.latitude, position.coords.longitude, function (data) {
          if (data.statusCode === '0000') {
            ...
            ToastsStore.warning(t`lanSPLabelErrorNotGettingLocationPleaseEnterManually`)
          }
        })
      },
        ...
        <form role='form'>
          ...
          <div>
            ...
            <div className='text-center'>
              <button disabled={this.state.submitDisabled} type='button' className='btn btn-primary mt-2' onClick={this.handleUpdateLocationDetails}>{t`lanCommonButtonUpdate`}</button>
