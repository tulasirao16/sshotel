            ...
            <div className='header-body'>
              <div className='row align-items-center py-4'>
                <div className='col-lg-6 col-7'>
                  <h6 className='h2 text-white d-inline-block mb-0'>{t`lanSPLabelCreateProperty`}</h6>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className='card'>
              <div className='card-header'>
                <h3 className='mb-0'>{t`lanSPLabelCreatePropertyManually`}</h3>
              </div>
                ...
                <form>
                  <div className='form-row justify-content-center'>
                    <div className='col-lg-6 mb-4'>
                      ...
                      <p className='text-center'>{t`lanSPLabelPleaseAddProprtyImages`}</p>
                    </div>
                  </div>
                  <div className='form-row justify-content-center'>
                  ...
                  <div className='form-row justify-content-center mt-3'>
                    ...
                    <div className='col-md-3 col-auto text-right'>
                      <button className='btn btn-primary' onClick={this.handleAddProperty} type='submit'>{t`lanSPButtonNext`}</button>
                    </div>
                  </div>
                </form>
              </div>
