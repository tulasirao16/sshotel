...
import SPPropertyLocationCreate from '../../../components/serviceproviders/Properties/SPPropertyLocationCreate'
import SPPropertyNearestAreasCreate from '../../../components/serviceproviders/Properties/SPPropertyNearestAreasCreate'
import SPBlockedDatesPropertyCreateComponent from '../../../components/serviceproviders/blockedDates/SPBlockedDatesPropertyCreateComponent'
import SPPropertyInfoCreate from '../../../containers/serviceproviders/PropertyInfos/SPPropertyInfoCreate'
import SPPropertyImages from './SPPropertyImages'
...
class SPPropertyCreateComponent extends React.Component {
  constructor () {
    super()
    this.state = {
  ...
  handleProperty = () => {
    ...
    let addAreas = this.state.nearestAreas && this.state.nearestAreas.length > 0 ? true : false
    let nearestAreas = this.state.nearestAreas
    let index = nearestAreas.indexOf(this.state.spLocationObj.area)
    if (this.state.images.length < 1) {
      ...
      this.setState({ errorMessage: t`lanSPErrorVideoSize` })
    ...
    } else if (spLocationObj && addAreas && index >= 0) {
      if (index >= 0) {
        this.setState({ errorMessage: t`lanSPLabelErrorLocationAreaAndNearestAreaAsSame` })
      }
    } else {
  ...
  handlePropertyCreate = () => {
    ...
    if (this.state.images.length < 1) {
      ...
      this.setState({ errorMessage: t`lanSPErrorAddPropertyInfoDetails` })
    } else if (spLocationObj && addAreas && index >= 0) {
      if (index >= 0) {
        this.setState({ errorMessage: t`lanSPLabelErrorLocationAreaAndNearestAreaAsSame` })
      }
      ...
      async.series([
        ...
        fetchPolyfill(config.baseUrl + config.postSPPropertyCreateAPI, {
          method: 'POST',
          body: data,
          headers: {
  ...
  render () {
    return (
      ...
      ? <SPPropertyInfoCreate amenitiesObj={this.state.amenitiesObj} createProperty={this.state.createProperty} infoFunction={this.infoFunction}
        ...
        <div className='container-fluid mt--6'>
          <div className='card property-view'>
            ...
            <div className='card-body'>
              <div>
                {this.state.photosStatus ? <SPPropertyImages videoError={this.state.videoError} photos={this.state.images} files={this.state.files} imageFunction={this.imageFunction} video={this.state.video} videoFiles={this.state.videoFiles} />
                : <div>
                  <div className='row'>
                      ...
                      <div className='accordion' id='accordionExample'>
                        ...
                        <div className='card'>
                          ...
                          <div id='collapseTwo' className='collapse' aria-labelledby='headingTwo' data-parent='#accordionExample'>
                            <div className='card-body'>
                              <SPPropertyLocationCreate commonFunction={this.commonFunction} spLocationObj={this.state.spLocationObj} />
                            </div>
                          </div>
                        </div>
                        <div className='card'>
                          ...
                          <div id='collapseThree' className='collapse' aria-labelledby='headingThree' data-parent='#accordionExample'>
                            <div className='card-body'>
                              <SPPropertyNearestAreasCreate commonFunction={this.commonFunction} nearestAreas={this.state.nearestAreas} spLocationObj={this.state.spLocationObj} />
                            </div>
                          </div>
                        </div>
                        <div className='card'>
                          ...
                          <div id='collapseFour' className='collapse' aria-labelledby='headingFour' data-parent='#accordionExample'>
                            <div className='card-body'>
                              <SPBlockedDatesPropertyCreateComponent commonFunction={this.commonFunction} blockedDatesObj={this.state.blockedDatesObj} />
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className='row'>
                    <div className='col-sm-12 text-center mt-2'>
                      ...
                      ? <button className='btn btn-primary' type='button' disabled={this.state.submitDisabled} onClick={this.handlePropertyCreate}>{t`lanCommonButtonCreate`}</button> : null}
...
export default SPPropertyCreateComponent
