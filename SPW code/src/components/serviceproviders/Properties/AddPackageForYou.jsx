            ...
            <div className='header-body'>
              <div className='row align-items-center py-4'>
                <div className='col-lg-6 col-7'>
                  <h6 className='h2 text-white d-inline-block mb-0'>{t`lanSPLabelAddPackagesFitForYou`}</h6>
                </div>
              </div>
              {/* Card stats */}
              <div className='row'>
                      ...
                      <div className='row'>
                        ...
                        <div className='col-auto'>
                          <div className='icon icon-shape bg-gradient-red text-white rounded-circle shadow'>
                            ...
                            <span className='h1 font-weight-bold mb-0 text-white'>{t`lanSPLabelS`}</span>
                          </div>
                        </div>
                      </div>
                      <p className='mt-3 mb-0 text-sm'>
                        <span className='h3 mb-0'>{t`lanSPLabelBedAndBreakfast`}</span>
                      </p>
                    </div>
                  </div>
                </div>
                      ...
                      <div className='row'>
                        ...
                        <div className='col-auto'>
                          <div className='icon icon-shape bg-gradient-orange text-white rounded-circle shadow'>
                            <span className='h1 font-weight-bold mb-0 text-white'>{t`lanSPLabelP`}</span>
                          </div>
                        </div>
                      </div>
                      <p className='mt-3 mb-0 text-sm'>
            ...
            <div className='col-xl-3 col-md-6'>
              <div className='card '>
                ...
                <div className='card-body'>
                  ...
                  <p className='mt-3 mb-0 text-sm'>
                    <span className='h3 mb-0'>{t`lanSPLabel1BHParking`}</span>
                  </p>
                </div>
              </div>
            </div>
            <div className='col-xl-3 col-md-6'>
              <div className='card '>
                ...
                <div className='card-body'>
                  ...
                  <p className='mt-3 mb-0 text-sm'>
                    <span className='h3 mb-0'>{t`lanSPLabelAppartmentParking`}</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='col-xl-3 col-md-6'>
              <div className='card bg-gradient-default border-0 text-center'>
                ...
                <div className='card-body'>
                  ...
                  <p className='mt-3 mb-0 text-sm'>
                    <a href='#' onClick={this.handleAddManually}><span className='h3 mb-0 text-white'>{t`lanSPLabelAddAnotherProperty`}</span></a>
                  </p>
                </div>
              </div>
            </div>
