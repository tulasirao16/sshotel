...
class SPPropertyInfoCreateComponent extends React.Component {
  ...
  constructor (props) {
    ...
    this.state = {
      ...
      isCreateProperty: props.createProperty
    }
  ...
  handleCreatePropertyInfo () {
    ...
    if (!this.state.rentType) {
      ...
      this.setState({ errorMessage: t`lanSPLabelErrorCreateErrorInPricing` })
    } else if (!this.state.isSavedPricing) {
      this.setState({ errorMessage: t`lanSPLabelErrorSavingErrorInPricing` })
          ...
          <div>
            <div className='card Create-Propety-Info'>
              ...
              <div className='card-body'>
                <div className='accordion' id='accordionExample'>
                      ...
                      <div className='card-body'>
                        <form>
                            ...
                            <div className='col-md-3'>
                              <div className='form-group'>
                                ...
                                <select className='form-control' id='exampleFormControlSelect1' value={this.state.rentType} onChange={(event) => this.setState({ rentType: event.target.value, errorMessage: '' })}>
                                  <option value=''>{t`lanSPLabelRentType`}</option>
                            ...
                            <div className='col-md-3'>
                              <div className='form-group'>
                                ...
                                <select className='form-control' id='exampleFormControlSelect1' value={this.state.roomType} onChange={(event) => this.setState({ roomType: event.target.value, errorMessage: '' })}>
                                  <option value=''>{t`lanSPLabelRoomType`}</option>
                            ...
                            <div className='col-md-3'>
                              <div className='form-group'>
                                ...
                                <select className='form-control' id='exampleFormControlSelect1' value={this.state.roomCategory}
                                  ...
                                  <option value=''>{t`lanSPLabelRoomCategory`}</option>
                          ...
                          <div className='row'>
                            ...
                            <div className='col-md-3'>
                              <div className='form-group'>
                                <label className='form-control-label'>{t`lanSPLabelSingleBeds`}<span className='require'>*</span></label>
                            ...
                            <div className='col-md-3'>
                              <div className='form-group'>
                                <label className='form-control-label'>{t`lanSPLabelDoubleBeds`}<span className='require'>*</span></label>
                            ...
                            <div className='col-md-3'>
                              ...
                              <div className='form-group'>
                                <Switch
                                  ...
                                  onChange={(status) => this.setState({ status: status ? 'Active' : 'Inactive', errorMessage: '' })}
                  ...
                  <div className='card'>
                    ...
                    <div id='collapseTwo' className='collapse' aria-labelledby='headingTwo' data-parent='#accordionExample'>
                      <div className='card-body'>
                        <SPPropertyInfoPriceCreate handlePricingChange={this.handlePricingChange} commonFuntion={this.commonFuntion} priceObj={this.state.priceObj} isCreateProperty={this.state.isCreateProperty} />
                      </div>
                    </div>
                  </div>
                  <div className='card'>
                ...
                <div className='container text-center'>
                  <button className='btn btn-primary' disabled={this.state.buttonDisabled} onClick={this.handleCreatePropertyInfo} type='button'>{t`lanCommonButtonCreate`}</button>
