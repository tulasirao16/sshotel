...
import SPPropertyInfoEditComponent from './SPPropertyInfoEditComponent'
import SPPropertyInfoPriceViewComponent from '../PropertyInfoPrices/SPPropertyInfoPriceViewComponent'
import SPAmenitiesListComponent from '../aminities/SPAmenitiesListComponent'
import SPServicesListComponent from '../Services/SPServicesListComponent'
import GuestRulesListComponent from '../guestRules/GuestRulesListComponent'
import '../css/all.min.css'
import '../css/argon.min.css'
import '../css/nucleo.css'

class SPPropertyInfoViewComponent extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
                  ...
                  <div className='accordion' id='accordionExample'>
                    <div className='card'>
                      ...
                      <div id='collapseOne' className='collapse show' aria-labelledby='headingOne' data-parent='#accordionExample'>
                        <SPPropertyInfoEditComponent propertyInfoViewObj={this.state.propertyInfoViewObj} propertyAction={this.state.propertyAction} commonFunction={this.commonFunction} />
                      </div>
                    </div>
                    <div className='card'>
                      ...
                      <div id='collapseTwo' className='collapse' aria-labelledby='headingTwo' data-parent='#accordionExample'>
                        <SPPropertyInfoPriceViewComponent propertyInfoPriceObj={this.state.propertyInfoViewObj} commonFunction={this.commonFunction} />
                      </div>
                    </div>
                    <div className='card'>
                      ...
                      <div id='collapseThree' className='collapse' aria-labelledby='headingThree' data-parent='#accordionExample'>
                        <SPAmenitiesListComponent propertyInfoId={this.state.propertyInfoViewObj._id} propertyId={this.state.propertyInfoViewObj.propertyId._id} />
                      </div>
                    </div>
                    <div className='card'>
                      ...
                      <div id='collapseFour' className='collapse' aria-labelledby='headingFour' data-parent='#accordionExample'>
                        <SPServicesListComponent propertyInfoId={this.state.propertyInfoViewObj._id} propertyId={this.state.propertyInfoViewObj.propertyId._id} />
                      </div>
                    </div>
                    <div className='card'>
                      ...
                      <div id='collapseFive' className='collapse' aria-labelledby='headingFive' data-parent='#accordionExample'>
                        <GuestRulesListComponent propertyInfoId={this.state.propertyInfoViewObj._id} propertyId={this.state.propertyInfoViewObj.propertyId._id} />
                      </div>
                    </div>
                  </div>
                </div>
...
SPPropertyInfoViewComponent.propTypes = {
  propertyInfoViewObj: PropTypes.any
}

export default SPPropertyInfoViewComponent
