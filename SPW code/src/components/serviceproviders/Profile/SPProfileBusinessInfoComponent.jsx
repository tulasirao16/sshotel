...
class SPProfileBusinessInfoComponent extends React.Component {
  ...
  componentWillMount () {
    ...
    this.setState({
      ...
      zip: authObj && authObj.spServiceProviderId.zip ? authObj.spServiceProviderId.zip : ''
    })
  }
  handleUserProfile () {
                ...
                <div className='card-header'>
                  <div className='row'>
                    <div className='col-sm-12'>
                      ...
                      : <h5 className='card-title'>{ t`lanSPTitleEditBusinessInfo` }</h5>
                      }
                    </div>
                  ...
                  <form>
                    ...
                    <div className='row'>
                      <div className='col-sm-12 text-center'>
                        <button type='button' className='btn btn-primary' disabled={this.state.submitDisabled} onClick={this.handleUpdateDetails}>{ t`lanCommonButtonUpdate` }</button>
