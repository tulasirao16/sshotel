    ...
    class SPUserProfileComponent extends React.Component {
      constructor () {
        super()
          ...
          fetchPolyfill(config.baseUrl + config.putSPUserProfileAPI + '_id', {
            ...
            response.json().then((body) => {
              ...
              if (response.status === 200) {
                ...
                ToastsStore.success(t`lanSPLabelSuccessProfileUpdatedSuccessfully`)
                this.props.updateAuthObj()
                this.setState({ disabled: true })
              } else {
                ToastsStore.error(t`lanSPLabelErrorProfileUpdateFailed`)
              }
            })
          })
        }
                    ...
                    <div className='col-lg-6 col-7'>
                      ...
                      <nav aria-label='breadcrumb' className='d-none d-md-inline-block ml-md-4'>
                        <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                          ...
                          <li className='breadcrumb-item active' aria-current='page'>{ t`lanSPTitleProfile` }</li>
                        </ol>
                      </nav>
                    </div>
                  </div>
                    ...
                    <div className='card-header'>
                      <div className='row'>
                        <div className='col-sm-12'>
                          {this.state.disabled
                          ? <h5 className='card-title'>{ t`lanSPTitleProfile` }</h5>
                      ...
                      <form>
                        ...
                        <div className='row'>
                          <div className='col-sm-12 text-center'>
                            {!this.state.disabled
                            ? <button type='button' className='btn btn-primary' onClick={this.updateProfiledetails}>{ t`lanCommonButtonUpdate` }</button>
                            : null }
                          </div>
                        </div>
                      </form>
    ...
    export default SPUserProfileComponent
