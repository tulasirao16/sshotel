      ...
      fetchPolyfill(config.baseUrl + config.putSPUserProfileAPI + '_id', {
        ...
        response.json().then((body) => {
          ...
          if (response.status === 200) {
            ...
            ToastsStore.success(t`lanSPLabelSuccessAddressUpdatedSuccessfully`)
            setTimeout(() => {
              hashHistory.push('/host/user/profile')
            }, 2000)
          } else {
            ToastsStore.error(t`lanSPLabelErrorAddressUpdateFailed`)
          }
        })
      })
    }
                  ...
                  <form>
                      ...
                      <div className='col-md-6'>
                        <div className='form-group'>
                          ...
                          <select className='form-control' id='country' onChange={() => this.setState({ country: event.target.value, errorMessage: '' })} value={this.state.country} >
                            {this.state.countryOrg ? null : <option value=''>{ t`lanCommonLabelSelectCountry`}</option>}
                      ...
                      <div className='col-md-6'>
                        <div className='form-group'>
                          ...
                          <select className='form-control' id='state' onChange={() => this.setState({ state: event.target.value, errorMessage: '' })} value={this.state.state}>
                            {this.state.stateOrg ? null : <option value=''>{ t`lanCommonLabelSelectState`}</option>}
                    ...
                    <div className='row'>
                      <div className='col-sm-12 text-center'>
                        <button type='button' className='btn btn-primary' disabled={this.state.submitDisabled} onClick={this.updateProfileAddressdetails}>{ t`lanCommonButtonUpdate` }</button>
