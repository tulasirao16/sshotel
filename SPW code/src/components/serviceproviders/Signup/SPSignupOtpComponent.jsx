            ...
            <div className='modal-content'>
              ...
              ? <div className='modal-body'>
                ...
                <div className='text-center mb-3'>
                  <h4 className='heading'>{t`lanSPLabelHi`} {this.state.name.trim() ? this.state.name : t`lanSPLabelGuest`}</h4>
                ...
                <div className='form-row text-center'>
                  <div className='col'>
                    <button type='button' onClick={() => this.handleValidateOtp()} ref='mobileOtpNumberSubmit'
                      className='btn btn-primary mr-3'>{t`lanSPButtonSubmit`}</button>
                    <button type='button' ref='mobileOtpClose' className='btn btn-outline-default' data-dismiss='modal' aria-label='Close'>{t`lanSPButtonClose`}</button>
                  </div>
                </div>
                <div className='text-center mt-4'>
                  <div className='h4 font-weight-300'>
                    <p>{t`lanSPLabelOTP`}: {this.state.otpValue}</p>
              ...
              : <div className='modal-body'>
                ...
                <div className='text-center mb-3'>
                  <h4 className='heading'>{t`lanSPLabelHi`} {this.state.contactPerson.trim() ? this.state.contactPerson : t`lanSPLabelGuest`}</h4>
                  <p>{this.state.errorMessage}</p>
                </div>
                <div className='form-row mt-3 text-center'>
                  <div className='col'>
                    <button type='button' ref='mobileOtpClose' className='btn btn-outline-default' data-dismiss='modal' aria-label='Close'>{t`lanSPButtonOkay`}</button>
                  </div>
                </div>
              </div>}
            </div>
          ...
          <div className='modal-dialog modal- modal-dialog-centered modal-sm' role='document'>
            <div className='modal-content'>
              ...
              : <div className='modal-body'>
                ...
                <div className='form-row mt-3 text-center'>
                  <div className='col'>
                    <button type='button' ref='emailOtpClose' className='btn btn-outline-default' data-dismiss='modal' aria-label='Close'>{t`lanSPButtonOkay`}</button>
                  </div>
                </div>
              </div>}
            </div>
