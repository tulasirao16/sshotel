...
class DrawerWithHeader extends React.Component {
  ...
  constructor () {
    ...
    this.handleSPCreateBookings = this.handleSPCreateBookings.bind(this)
  ...
  componentWillMount () {
    ...
    } else if (authObj && authObj.userType && this._isMounted) {
      this.setState({ menuItem: localStorage.getItem('menuItem') })
      let obj = {
        unBlockStatus: true,
        url: config.baseUrl + config.getSPNotificationsUnReadCountAPI }
      let _this = this
  ...
  handleSPCreateBookings (e) {
    localStorage.setItem('menuItem', 'CreateBookings')
              ...
              <div className='navbar-inner'>
                ...
                <div className='collapse navbar-collapse' id='sidenav-collapse-main'>
                  ...
                  <ul className='navbar-nav'>
                    ...
                    <li className='nav-item'>
                      <a className={classnames('nav-link', { 'active': this.state.menuItem === 'CreateBookings' })} onClick={this.handleSPCreateBookings} >
                        <i className='ni ni-bullet-list-67 text-info' />
                        <span className='nav-link-text'>{t`lanSPButtonCreateBookings`}</span>
                      </a>
                    </li>
                    <li className='nav-item'>
                ...
                <ul className='navbar-nav align-items-center ml-auto ml-md-auto'>
                  ...
                  <li className='nav-item dropdown'>
                    <a className='nav-link' role='button' onClick={this.handleNotification} >
                      <span> <i className='fas fa-bell bell-icon' /></span>
                    ...
                    <div className='dropdown-menu dropdown-menu-xl dropdown-menu-right py-0 overflow-hidden'>
                      ...
                      <div className='px-3 py-3'>
                        <h6 className='text-sm text-muted m-0'>{t`lanSPLabelYouHave`} <strong className='text-primary'>13</strong>{t`lanSPLabelNotifications`} </h6>
                      </div>
                      {/* List group */}
                          ...
                          <div className='row align-items-center'>
                            ...
                            <div className='col-auto'>
                              <div className='d-flex justify-content-between align-items-center'>
                                <div>
                                  <h4 className='mb-0 text-sm'>{t`lanSPLabelJohnSnow`} </h4>
                                </div>
                                <div className='text-right text-muted'>
                                  <small>2 {t`lanSPLabelHrsAgo`}</small>
                                </div>
                              </div>
                              <p className='text-sm mb-0'>{t`lanSPLabelLetSMeetAtStarbucksAt11:30Wdyt`}?</p>
                            </div>
                          </div>
                        </a>
                        <a href='#!' className='list-group-item list-group-item-action'>
                          <div className='row align-items-center'>
                            ...
                            <div className='col-auto'>
                              <div className='d-flex justify-content-between align-items-center'>
                                ...
                                <div className='text-right text-muted'>
                                  <small>3 {t`lanSPLabelHrsAgo`}</small>
                                </div>
                              </div>
                              <p className='text-sm mb-0'>{t`lanSPLabelANewIssueHasBeenReportedForArgon`}</p>
                            </div>
                          </div>
                        </a>
                        <a href='#!' className='list-group-item list-group-item-action'>
                          <div className='row align-items-center'>
                            ...
                            <div className='col-auto'>
                              <div className='d-flex justify-content-between align-items-center'>
                                ...
                                <div className='text-right text-muted'>
                                  <small>5 {t`lanSPLabelHrsAgo`}</small>
                                </div>
                              </div>
                              <p className='text-sm mb-0'>{t`lanSPLabelYourPostsHaveBeenLikedALot`}</p>
                            </div>
                          </div>
                        </a>
                        <a href='#!' className='list-group-item list-group-item-action'>
                        ...
                        <a href='#!' className='list-group-item list-group-item-action'>
                          <div className='row align-items-center'>
                            ...
                            <div className='col-auto'>
                              ...
                              <p className='text-sm mb-0'>{t`lanSPLabelANewIssueHasBeenReportedForArgont`}</p>
                            </div>
                          </div>
                        </a>
                      </div>
                      {/* View all */}
                      <a href='#!' className='dropdown-item text-center text-primary font-weight-bold py-3'>{t`lanSPLabelViewAll`}</a>
                    </div>
                  </li>
                  {/* <li className='nav-item dropdown'>
