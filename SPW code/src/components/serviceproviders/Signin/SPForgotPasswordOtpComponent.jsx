                        ...
                        <form role='form'>
                          ...
                          <div>
                            <div className='text-center mt-4'>
                              <button disabled={this.state.buttonDisabled} type='button' ref='otpNumberSubmit' className='btn btn-primary mt-2' onClick={this.handleOtpDone}>{t`lanCommonButtonDone`}</button>
                            </div>
                          </div>
