                      ...
                      <div className='details'>
                        ...
                        <div className='form-group'>
                          ...
                          <input autoFocus type='text' className='input-text' id='email-phone' maxLength={80}
                            onKeyPress={this.handleEnter} value={this.state.userId} onChange={() => this.setState({ userId: event.target.value, errorMessage:'' })} />
                        ...
                        <div className='mb-4 text-center'>
                          <button disabled={this.state.buttonDisabled} type='button' onClick={this.handleSendOTP} className='btn-md btn-theme'>{t`lanSPButtonSendOtp`}</button>
                        </div>
                      </div>
                    </div>
                  </div>
