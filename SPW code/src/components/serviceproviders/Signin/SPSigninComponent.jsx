                    ...
                    <div className='details'>
                      ...
                      <div className='form-group'>
                        ...
                        <input autoFocus type='text' className='input-text' id='userid' value={this.state.userid}
                          onKeyDown={this.handleEnter} onChange={(e) => this.setState({ userid: e.target.value, useridErrorMessage: '', errorMessage: '' })} maxLength={60} />
                      ...
                      <div className='form-group'>
                        ...
                        <input className='input-text' type={this.state.showPassword ? 'text' : 'password'} id='password' value={this.state.password} maxLength={20}
                          onKeyDown={this.handleEnter} onChange={() => this.setState({ password: event.target.value, passwordErrorMessage: '', errorMessage: '' })} />
                      ...
                      <div className='form-group text-center'>
                        <button disabled={this.state.buttonDisabled} type='button' onClick={this.handleSubmitLogin} className='btn-md btn-theme'>{t`lanSPButtonSignin`}</button>
                      </div>
                      {/* <div className='mt-2'>
