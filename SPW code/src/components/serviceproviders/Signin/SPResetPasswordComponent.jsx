                      ...
                      <div className='details'>
                        ...
                        <form role='form'>
                          ...
                          <div className='text-center'>
                            <button disabled={this.state.buttonDisabled} type='button' className='btn btn-primary mt-2' onClick={this.handleResetPasswordDone}>{t`lanCommonButtonDone`}</button>
                          </div>
                        </form>
                      </div>
                    </div>
