...
class CreateBookingPropertyInfoListComponent extends React.Component {
  ...
  componentWillMount () {
    ...
    // this.setState({ propertyId: propertyData.propertyId._id })
    // let obj = { url: config.baseUrl + config.getSPPropertyInfosListAPI + propertyData.propertyId._id }
    // let _this = this
    ...
    let obj = {
      unBlockStatus: true,
      url: config.baseUrl + config.getSPPropertyInfosListAPI + propertyData._id }
    let _this = this
    APICallManager.getCall(obj, function (resObj) {
      if (resObj.data.statusCode === '0000') {
        _this.setState({
                ...
                <div className='col-lg-6 col-12'>
                  ...
                  <nav aria-label='breadcrumb' className='d-md-inline-block ml-md-4'>
                    <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                      ...
                      <li className='breadcrumb-item'><a onClick={() => hashHistory.push('/host/create-booking/properties-list')}>{t`lanSPTitlePropertiesList`}</a></li>
                      <li className='breadcrumb-item active' aria-current='page'>{t`lanSPTitlePropertiesInfoList`}</li>
                    </ol>
                  </nav>
                </div>
              </div>
                                        ...
                                        <li className='list-group-item px-0 pb-0'>
                                          <div className='row align-items-center'>
                                            <div className='col-auto'>
                                              ...
                                              <span className='h2 font-weight-bold mb-0'>Rs. {item.pricing.totalPrice} /- <small>{item.pricing.billingType}</small> </span>
                                            </div>
                                          </div>
                                        </li>
                                      </ul>
