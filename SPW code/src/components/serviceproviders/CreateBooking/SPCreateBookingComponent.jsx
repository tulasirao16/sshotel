...
import { t } from 'ttag'
import SPCreateDaysBookingComponent from './SPCreateDaysHotelBooking'
import SPCreateHourlyBookingComponent from './SPCreateHourlyHotelBooking'
...
class SPCreateBooking extends React.Component {
  ...
  componentWillMount () {
    let getSpPropertyInfoAmenities = {
      unBlockStatus: true,
      url: config.baseUrl + config.getSPPropertyInfoAmenitiesListAPI + this.state.propertyId + '/' + this.state.propertyInfoData._id + '/' + this.state.searchString
    }
    let _this = this
    ...
    let getSpPropertyInfoGuestRulesList = {
      unBlockStatus: true,
      url: config.baseUrl + config.getSPPropertyInfoGuestRulesListAPI + this.state.propertyId + '/' + this.state.propertyInfoData._id + '/' + this.state.searchString
    }
    ...
    let getSpPropertyInfoServices = {
      unBlockStatus: true,
      url: config.baseUrl + config.getSPPropertyInfoServicesListAPI + this.state.propertyId + '/' + this.state.propertyInfoData._id
    }
                ...
                <div className='col-lg-6 col-7'>
                  ...
                  <nav aria-label='breadcrumb' className='d-md-inline-block ml-md-4'>
                    <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                      ...
                      <li className='breadcrumb-item active' aria-current='page'>{t`lanSPLabelCreateBooking`}</li>
                    </ol>
                  </nav>
                </div>
              </div>
                  ...
                  <div className='accordion' id='accordionExample'>
                    <div className='card'>
                      <div className='card-header' id='headingOne' data-toggle='collapse' data-target='#collapseOne' aria-expanded='true' aria-controls='collapseOne'>
                        <h5 className='mb-0'>{t`lanSPLabelCreateBooking`}</h5>
                      </div>
                      <div id='collapseOne' className='collapse show' aria-labelledby='headingOne' data-parent='#accordionExample'>
                        <div className='card-body'>
                          {this.state.propertyInfoData.pricing.minBasePriceUnit === '6 Hours' ? <SPCreateHourlyBookingComponent />
                          : <SPCreateDaysBookingComponent /> }
