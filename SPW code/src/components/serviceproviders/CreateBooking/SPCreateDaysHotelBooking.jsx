...
class SPCreateDaysBookingComponent extends React.Component {
  constructor (props) {
    super(props)
  ...
  handleCheckOutDate (checkOutDate) {
    ...
    if (checkOutDateValue < checkInDateValue) {
      alert(t`lanSPLabelErrorCheckOutDateShouldNotBeLessThanCheckInDate`)
    } else {
  ...
  handleCreateBooking () {
    ...
    if (this.state.checkInDate === null || this.state.checkInDate === undefined || this.state.checkInDate === '') {
      ...
      ToastsStore.warning(t`lanSPLabelErrorPleaseClickOnMobileNumberGetDetailsToGetUserDetails`)
        ...
        <div className='row'>
          {/* <div className='col-md-3'>
            <div className='form-group'>
              ...
              <input type='text' value={this.state.amountPerDay}
            ...
            <div className='row'>
              <div className='col-md-6'>
                <div className='form-group'>
                  ...
                  <input type='text' value={this.state.noOfDays} className='form-control' id='TicketSubject' readOnly />
                  <span className='input-error-icon' ><i className='far fa-times-circle' style={this.state.tSubjectError ? { color: 'red', fontSize: 13 } : { opacity: 0 }} /></span>
                  <p className='text-muted'><small style={{ color: 'red', fontSize: 13 }}>{this.state.tSubjectError}</small> </p>
                </div>
              </div>
              <div className='col-md-6'>
                <div className='form-group'>
                  ...
                  <input type='text' value={(this.state.numOfRooms) * (this.state.noOfDays) * (this.state.amount)} className='form-control' id='ticketOn' readOnly />
                  <span className='input-error-icon' ><i className='far fa-times-circle' style={this.state.ticketOnError ? { color: 'red', fontSize: 13 } : { opacity: 0 }} /></span>
                  <p className='text-muted'><small style={{ color: 'red', fontSize: 13 }}>{this.state.ticketOnError}</small> </p>
                </div>
              </div>
...
export default SPCreateDaysBookingComponent
