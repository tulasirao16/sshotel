...
import SPAmenitiesCreateViewComponent from './SPAmenitiesCreateViewComponent'
...
class SPAmenitiesCreateComponent extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      reload: false,
  ...
  handleAmenityCreate () {
    ...
    ToastsStore.success(t`lanSPLabelSuccessAmenitiesCreated`)
  ...
  render () {
    ...
    </div> : <SPAmenitiesCreateViewComponent handleAmenitiesChange={this.props.handleAmenitiesChange} amenitiesObj={this.state.amenitiesObj}
...
SPAmenitiesCreateComponent.propTypes = {
...
export default SPAmenitiesCreateComponent
