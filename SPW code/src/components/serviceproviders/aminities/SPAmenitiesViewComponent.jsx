...
class SPAminityView extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      date: new Date(),
          ...
          <section className='notifications'>
            ...
            <div className='row'>
              <div className='col-md-12 text-center'>
                ...
                <button className='btn btn-default' onClick={this.handleAmenityBack}>{t`lanCommonButtonBack`}</button>
              </div>
            </div>
          </section>
        </div>
              ...
              <div className='header-body'>
                <div className='row align-items-center py-4'>
                  <div className='col-lg-6 col-7'>
                    <h6 className='h2 text-white d-inline-block mb-0'>{t`lanSPLabelAmenityView`}</h6>
                  </div>
