...
class SPLocationCreateComponent extends React.Component {
      ...
      (position) => {
        ...
        this.getLocation(position.coords.latitude, position.coords.longitude, function (data) {
          if (data.statusCode === '0000') {
            ...
            ToastsStore.error('Not Getting Location.Please Enter Manually')
          }
        })
      },
  ...
  handleSubmitLocationDetails () {
    ...
    if (!this.state.address.trim()) {
      ...
      let obj = { url: config.baseUrl + config.postSPLocationCreateAPI, routing: '/host/locations', body: postLocData }
      APICallManager.postCall(obj, function (resObj) {
        _this.setState({ submitDisabled: true })
        if (resObj.data.statusCode === '0000') {
          ToastsStore.success(t`lanSPLabelSuccessLocationCreatedSuccessfully`)
          setTimeout(() => {
            hashHistory.push('/host/locations')
          }, 2000)
        } else {
          ToastsStore.error(t`lanSPLabelErrorLocationCreateFailed`)
        }
      })
    }
  }
                ...
                <div className='col-lg-6 col-7'>
                  ...
                  <nav aria-label='breadcrumb' className='d-none d-md-inline-block ml-md-4'>
                    <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                      ...
                      <li className='breadcrumb-item active'>{ t`lanSPTitleLocationCreate` }</li>
                    </ol>
                  </nav>
                </div>
                  ...
                  <form role='form'>
                    ...
                    <div>
                      ...
                      <div className='text-center'>
                        <button type='button' className='btn btn-primary mt-2' disabled={this.state.submitDisabled} onClick={this.handleSubmitLocationDetails}>{t`lanCommonButtonCreate`}</button>
