...
class SPLocationsListComponent extends React.Component {
  ...
  handlePageChange (pageNumber) {
    if (this.state.activePage !== pageNumber) {
      ...
      let obj = {
        unBlockStatus: true,
        url: config.baseUrl + config.getSPLocationsListAPI + '/' + pageNumber + '/' + this.state.searchString }
  ...
  inactivateLocation (locationObj) {
    ...
    APICallManager.putCall(obj, function (resObj) {
      if (resObj.data.statusCode === '0000') {
        ...
        ToastsStore.success(t`lanSPLabelErrorLocationInactivationFailed`)
      }
    })
  }
  activateLocation (locationObj) {
    ...
    APICallManager.putCall(obj, function (resObj) {
      if (resObj.data.statusCode === '0000') {
        ...
        ToastsStore.success(t`lanSPLabelErrorLocationActivationFailed`)
      }
    })
  }
  handleHome () {
