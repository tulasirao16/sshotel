...
class SPHourlyEditBooking extends React.Component {
  constructor (props) {
    ...
    this.state = {
      ...
      buttonDisable: false,
      BookingEditFrom: localStorage.getItem('BookingEditFrom', 'Bookings Page')
    }
  ...
  componentWillUnmount () {
    localStorage.removeItem('BookingEditFrom', 'Bookings Page')
  }
  ...
  handleEditBooking () {
    ...
    if (this.state.bookingStatus === bookingData.bookingStatus && this.state.totalDays === bookingData.totalDays && this.state.paymentStatus === bookingData.paymentStatus &&
      ...
      if (this.state.BookingEditFrom === 'Bookings Page') {
      ...
      ToastsStore.error(t`lanSPLabelSpHourlyEditBookingSelectPaymentMode`)
      ...
      APICallManager.putCall(obj, function (resObj) {
        if (resObj.data.statusCode === '0000') {
          ToastsStore.success(t`lanSPLabelSuccessBookingUpdatedSuccessfully`)
          setTimeout(() => {
            if (_this.state.BookingEditFrom === 'Bookings Page') {
              hashHistory.push('/host/home/bookings')
            } else {
              hashHistory.push('/host/bookings-history')
            }
          ...
          ToastsStore.error(t`lanSPLabelErrorBookingUpdateFailedTryAgain`)
                ...
                <div className='col-lg-6 col-7'>
                  <nav aria-label='breadcrumb' className='d-none d-md-inline-block ml-md-4'>
                    <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                      <li className='breadcrumb-item'><a onClick={() => hashHistory.push('/host/home')}><i className='fas fa-home' /></a></li>
                      {this.state.BookingEditFrom === 'Bookings Page'
                      ? <li className='breadcrumb-item'><a onClick={this.handleBack}>{ t`lanSPButtonBookingsPage` }</a></li>
                ...
                <div className='card-body'>
                  <section className='notifications'>
                        ...
                        <div className='row'>
                          ...
                          <div className='col-md-6'>
                            <div className='form-group'>
                              ...
                              <input type='text' value={this.state.bookingData.euMobileNumber} className='form-control' id='ticketOn' readOnly />
                    ...
                    <div className='row'>
                      <div className='col-md-6'>
                        <div className='row'>
                          <div className='col-md-6'>
                            <div className='form-group'>
                              <label className='form-control-label'>{t`lanSPLabelCheckInTime`} {t`lanCommonLabelDate`}<span className='error'>*</span></label>
                              <DatePicker
                          ...
                          <div className='col-md-6'>
                            <div className='form-group'>
                              <label className='form-control-label'>{t`lanSPLabelCheckOutTime`} {t`lanCommonLabelDate`}<span className='error'>*</span></label>
                    ...
                    <div className='row'>
                      <div className='col-md-3'>
                        <div className='form-group'>
                          <label className='form-control-label'>{t`lanEULabelNoOfDaysHours`} (#)<span className='error'>*</span></label>
                          <input type='text' value={`${this.state.totalDays} days / ${this.state.hours} hours`} onChange={this.handleOnChange} className='form-control' id='TicketSubject' />
                          <span className='input-error-icon' ><i className='far fa-times-circle' style={this.state.tSubjectError ? { color: 'red', fontSize: 18 } : { opacity: 0 }} /></span>
                          <p className='text-muted'><small style={{ color: 'red' }}>{this.state.tSubjectError}</small> </p>
                        </div>
                      </div>
...
SPHourlyEditBooking.propTypes = {
  bookingData: PropTypes.any
}
export default SPHourlyEditBooking
