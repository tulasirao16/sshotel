...
class EUBookingMobilePaymentFail extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      amount: '',
          ...
          <main className='main-content enduser_payment' style={{ paddingTop:'2%' }} >
            <section className='wb-section ' id='products'>
              <div className='container'>
                <div className='row mobileView_paymentfail'>
                                  ...
                                  <div className='row justify-content-center'>
                                    <div className='col-md-6 col-lg-6 col-sm-6 border border-success rounded-lg  col-xl-6 col-12'>
                                      <div className='row row-data-style py-2'>
                                        <div className='col-sm-6 col-6 text-left '><small>Booking Code</small></div>
                                      ...
                                      {/* <div className='row row-data-style py-2'>
                                        <div className='col-sm-6 col-6 text-left'><small>Payment Method</small></div>
                                        <div className='col-sm-6 col-6 text-left'>
                                          <h5 className='mb-0 text-sm'>{this.state.paymentMode ? this.state.paymentMode : ''}</h5>
                                        </div>
                                      </div> */}
                                      <div className='row row-data-style py-2'>
...
EUBookingMobilePaymentFail.propTypes = {
  params: PropTypes.any
}
export default EUBookingMobilePaymentFail
