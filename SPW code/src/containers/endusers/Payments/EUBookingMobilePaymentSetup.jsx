                            ...
                            <div className='seller-info'>
                              <ul className='list-group mb-0'>
                                ...
                                <li className='list-group-item d-flex justify-content-between lh-condensed'>
                                  ...
                                  {/* <span>₹ {(this.state.bookingPaymentInfo && this.state.bookingPaymentInfo.totalAmount && this.state.bookingPaymentInfo.amount) ? parseInt(this.state.bookingPaymentInfo.amount) - parseInt(this.state.bookingPaymentInfo.amount) : '0'}.00</span> */}
                                </li>
