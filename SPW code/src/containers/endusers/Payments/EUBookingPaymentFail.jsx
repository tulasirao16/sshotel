...
// import { t } from 'ttag'
class EndUsersPaymentFail extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      amount: '',
  ...
  componentWillMount () {
    ...
    let obj = {
      unBlockStatus: true,
      url: config.baseUrl + config.getEUBookingPaymentGatewayResponseStatusAPI + paymentResHash }
                    ...
                    <div className='col-lg-6 col-12'>
                      ...
                      <nav aria-label='breadcrumb eu eu-font' className='d-md-inline-block ml-md-4'>
                        <ol className='breadcrumb breadcrumb-links breadcrumb-dark'>
                          ...
                          <li className='breadcrumb-item active eu-font' aria-current='page'><a >Payment Failed</a></li>
                        </ol>
                      </nav>
                    </div>
                  </div>
                    ...
                    <div className='card-header py-2'>
                      <div className='row  '>
                        <div className='col-sm-12'>
                          <h6 className='h2 text-primary d-inline-block pt-2'> Payment Failed</h6>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className='container payment-success'>
                        <div className='row '>
                          <div className='col-sm-12 col-12 text-center pb-5 pt-0'>
                            <div>
                              <p className='eu-font'><i className='fas fa-times-circle pb-2' style={{ color:'red', fontSize:35 }} /> <br />Thank you, <br />Payment of ₹ {this.state.amount} is failed... </p>
                            </div>
                          </div>
                        </div>
                        <div className='row justify-content-center'>
                          <div className='col-md-6 col-lg-6 col-sm-6 border border-danger rounded-lg  col-xl-6 col-12 text-center'>
                            <div className='row row-data-style justify-content-center pt-4 pb-2'>
                            ...
                            {/* <div className='row row-data-style justify-content-center pb-4 pt-2'>
            ...
            <div className='col-sm-8'>
              <div className='card'>
                <div className='card-header text-center py-5'>
                  <div>
                    <label><i className='fas fa-times-circle pb-2' style={{ color:'red', fontSize:35 }} /> <br />Thank you, <br />Payment of ₹ {this.state.amount} is failed... </label>
                  </div>
                </div>
                <div className='card-body'>
                    ...
                    <div className='col-sm-12 text-center'>
                      <div className='seller-contact-info'>
                        <dl className='dl-horizontal '>
                          <div className='row'>
                            <div className='col-sm-3'> <dt ><b>Booking Code</b></dt></div>
...
EndUsersPaymentFail.propTypes = {
  params: PropTypes.any
}
export default EndUsersPaymentFail
