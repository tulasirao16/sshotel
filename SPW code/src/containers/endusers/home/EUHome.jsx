...
class EUHomelandingPage extends React.Component {
  constructor () {
    ...
    this.handleTopbarGuestsApply = this.handleTopbarGuestsApply.bind(this)
  ...
  async handleTopbarSearchChange () {
    ...
    if (event.target.value.trim().length) {
      this.setState({
        isEnableTopbar: true, location: destination, destination: destination
      })
      const apiurl = `${config.googleMapsPlaceAutoCompleteAPI}${config.googleMapsAPIKey}&input=${destination}&location=${this.state.latitude},${this.state.longitude}&radius=2000`
      try {
        const result = await fetch(config.corsUrl + apiurl)
      ...
      this.setState({
        isEnableTopbar: false, location: destination, destination: destination
      })
    }
  }
  ...
  render () {
    ...
    return (
      <div className='cozyspace' >
                ...
                <div className='row'>
                    ...
                    <form>
                      <div className='form-group mb-0 pl-2'>
                        <div className='input-group col-sm-12 input-group-lg input-group-flush bg-white'>
                          <input type='search' className='form-control' placeholder={t`lanCommonLabelSearchLocation`} value={this.state.location} onChange={this.handleTopbarSearchChange} onClick={this.handleTopbarSearchChange} onKeyPress={this.handleOnKeyPress} required />
                        </div>
                      </div>
                    </form>
                  </div>
                  <div className='col-md-2 text-left'>
                    <div className='landing-search-checkIn pt-1 pl-3'>
                      <label className='mb-0' >{t`lanEULabelCheckIn`}</label>
                      <DatePicker
                  ...
                  <div className='col-md-2 text-left'>
                    <div className='landing-search-checkOut pt-1 pl-3'>
                      <label className='mb-0'>{t`lanEULabelCheckOut`}</label>
                      <DatePicker
                        onKeyDown={e => e.preventDefault()}
                        dateFormat='MMM dd, yyyy'
                  ...
                  <div className='col-md-3 m-auto text-left'>
                    <a onClick={this.handleTopbarGuestsDropdown} >
                      <label value='large' className='guest-label pl-3'>{this.state.guestAdultValue} {t`lanEULabelGuest`}, {this.state.guestRooms} {t`lanEULabelRoom`}</label>
                    </a>
                  </div>
        ...
        <main role='main' className='inner cover'>
          ...
          <header>
            <video playsInline autoPlay='autoplay' muted='muted' loop='loop'>
              <source src={require('../../../../assets/videos/blue-view.mp4')} type='video/mp4' />
            </video>
            <div className='container h-100'>
              <div className='d-flex h-100 text-center align-items-center'>
                <div className='w-100 text-white'>
                  <h1 className='font-weight-extrabold-sq pb-3 mt-4'>{t`lanEULabelHotelsResortsHomesMore`}</h1>
                  <div className='container'>
                    <div className='card mx-5 bg-self'>
                      <div className='row'>
                        <div className='col-md-4 m-auto'>
                          <form>
                            <div className='form-group mb-0 pl-2' style={{ position: 'relative' }}>
                              <div className='input-group col-sm-12 bg-self input-group-lg input-group-flush'>
                                <input type='search' className='form-control text-white' placeholder={t`lanCommonLabelSearchLocation`} value={this.state.location} onChange={this.handleSearchChange} onClick={this.handleSearchChange} onKeyPress={this.handleOnKeyPress} required />
                              </div>
                            </div>
                          </form>
                        </div>
                        <div className='col-md-2 text-left'>
                          <div className='landing-search-checkIn pt-1 pl-3'>
                            <label className='mb-0 text-white' >{t`lanEULabelCheckIn`}</label>
                            <DatePicker
                              onKeyDown={e => e.preventDefault()}
                              selected={this.state.checkInDate}
                              onChange={this.handleCheckInDate}
                        ...
                        <div className='col-md-2 text-left'>
                          <div className='landing-search-checkOut pt-1 pl-3'>
                            <label className='mb-0 text-white'>{t`lanEULabelCheckOut`}</label>
                            <DatePicker
                              onKeyDown={e => e.preventDefault()}
                              selected={this.state.checkOutDate}
                              onChange={this.handleCheckOutDate}
                        ...
                        <div className='col-md-3 m-auto text-left'>
                          <a onClick={this.handleGuestsDropdown} style={{ position: 'relative' }} >
                            <label value='large' className='guest-label text-white pl-3'>{this.state.guestAdultValue} {t`lanEULabelGuest`}, {this.state.guestRooms} {t`lanEULabelRoom`}</label>
                          </a>
                        </div>
                        <div className='col-sm-1 text-right'>
                          <div className='serch-big-btn'>
          ...
          ? <div className='overlay-guest-dropdown'>
            <div className='guest-dropdown-div'>
              <div className='card-body'>
                <div className='row mb-2'>
                  <div className='col-sm-3 py-2 col-3'>{t`lanEULabelAdults`}</div>
                ...
                <div className='row mb-2'>
                  <div className='col-sm-3 py-2 col-3'>{t`lanEULabelChildren`}</div>
                  <div className='col-sm-3 col-3'>
                ...
                <div className='row mb-2'>
                  <div className='col-sm-3 py-2 col-3'>{t`lanEULabelRooms`}</div>
                  <div className='col-sm-3 col-3'>
                ...
                <div className='row mt-3'>
                  <div className='col-sm-12 text-right'>
                    <button className='btn btn-danger' onClick={() => this.setState({ guestDropdownActive: false })} >{t`lanEUButtonClose`}</button>
        ...
        : null}
          {/* topbar guests dropdown */}
          {this.state.topbarGuests === true
            ? <div className='topbarGuestsDiv'>
              <a onMouseLeave={() => this.setState({ topbarGuests: false })} ><div className='guest-dropdown-div'>
                <div className='card-body'>
                  <div className='row mb-2'>
                    <div className='col-sm-3 py-2 col-3'>{t`lanEULabelAdults`}</div>
                    <div className='col-sm-3 col-3'>
                  ...
                  <div className='row mt-3'>
                    <div className='col-sm-12 text-right'>
                      <button className='btn btn-danger' onClick={() => this.setState({ topbarGuests: false })} >{t`lanEUButtonClose`}</button>
                      <button className='btn btn-primary' onClick={this.handleTopbarGuestsApply} > {t`lanEUButtonApply`}</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {this.state.isEnable
          ? <div className='overlay-search-bg animated bounce delay-2s'>
                  ...
                  <div className='col-sm-12'>
                    {this.state.predictions.map((predictions, index) => (
                      <a key={index} onClick={() => this.handleLocationData(predictions.description)}>
                        <div><label style={{ color: '#555', cursor: 'pointer' }} >{predictions.description}</label><br /></div>
                      </a>
                    ))}
                  </div>
                </div>
        ...
        : ''}
          {this.state.isEnableTopbar
          ? <div className='topbarSeachDiv overlay-search-bg animated bounce delay-2s'>
            <a onMouseLeave={() => { this.setState({ isEnableTopbar: false }) }}>
              <div className='search-bg-div'>
                <div className='card-body pt-1'>
                  <div className='row mb-2'>
                    <div className='col-sm-12 text-right'>
                      <a onClick={() => this.setState({ isEnableTopbar: false })}><span><i className='fa fa-times' /></span></a>
                    </div>
                    <div className='col-sm-12'>
                      {this.state.predictions.map((predictions, index) => (
                        <a key={index} onClick={() => this.handleLocationData(predictions.description)}>
                          <div><label style={{ color: '#555', cursor: 'pointer' }} ><span><i className='fa fa-fa-map-marker' /></span>{predictions.description}</label><br /></div>
                        </a>
                      ))}
                    </div>
                  </div>
          ...
          <section id='oe_tabs' className=''> <a className='tab-nav next-tab mobile-only-tabs'><i className='icon-font icon-arrow-right' /></a>
            ...
            <div className='mobileTabs'>
              <ul className='slides'>
                <li onClick={this.handleAllTypeSelected} className={classnames('', { 'selected': this.state.typeSelect })}><a data-web-extend-tag='oe_p_all'>{t`lanCommonLabelAll`}</a>
                </li>
                <li onClick={this.handleCityTypeSelected} className={classnames('', { 'selected': this.state.typeSelectCity })} >
                  <a className='tab-city' data-web-extend-tag='City' data-web-extend-tag-method='3' data-web-extend-tag-prefix='oe_p'>{t`lanCommonLabelCity`}</a>
                </li>
                <li onClick={this.handleMountainPlacesTab} className={classnames('', { 'selected': this.state.typeSelectHill })} >
                  <a className='tab-mountain' data-web-extend-tag='Mountain' data-web-extend-tag-method='3' data-web-extend-tag-prefix='oe_p'>{t`lanCommonLabelHillStations`}</a>
                </li>
                <li onClick={this.handleTraditionalTabSelected} className={classnames('', { 'selected': this.state.typeSelectTemple })} >
                  <a className='tab-alternative' data-web-extend-tag='Alternative' data-web-extend-tag-method='3' data-web-extend-tag-prefix='oe_p'>{t`lanCommonLabelTempleTowns`}</a>
                </li>
                <li onClick={this.handleResortTypeSelected} className={classnames('', { 'selected': this.state.typeSelectResort })} >
                  <a className='tab-rejuvenate' data-web-extend-tag='Rejuvenate' data-web-extend-tag-method='3' data-web-extend-tag-prefix='oe_p'>{t`lanCommonLabelResorts`}</a>
                </li>
                <li onClick={this.handleBeachPlacesTab} className={classnames('', { 'selected': this.state.typeSelectRemote })} >
                  <a className='tab-beach' data-web-extend-tag='Beach' data-web-extend-tag-method='3' data-web-extend-tag-prefix='oe_p'>{t`lanCommonLabelRemotePlaces`}</a>
                </li>
              </ul>
            </div>
          </section>
                ...
                <div className='row mb-2'>
                  <div className='col-md-12'>
                    <div className='typo-section-header-sq'>
                      <h2 className='text-align-center-sq'>{t`lanCommonLabelBeachPlaces`}</h2>
                    </div>
                  </div>
                  <div className='col-md-12 d-lg-flex align-items-center justify-content-end'>
                    <a onClick={this.handleAllHotelsList} className='text-muted text-sm'>{t`lanCommonLabelSeeAllPopularPlaces`}<i className='fas fa-angle-double-right ml-2' />
                    </a>
                  </div>
                </div>
                <div className='row most-popular '>
                  <div id='myCarousel' className='carousel slide mb-2' data-ride='carousel'>
                          ...
                          <div className='row'>
                              ...
                              <div className='img-div'>
                                ...
                                <div className='card-body overlay-content'>
                                  <div className='overlay-img-content'>
                                    <h6 className='card-title text-shadow text-uppercase'>{t`lanCommonLabelNewYork`}</h6>
                                    <p className='card-text text-sm'>{t`lanCommonLabelTheBigApple`}</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div className='col-lg-3 col-sm-4 pb-2 '>
                              <div className='img-div'>
                                ...
                                <div className='card-body overlay-content'>
                                  <div className='overlay-img-content'>
                                    <h6 className='card-title text-shadow text-uppercase'>{t`lanCommonLabelParis`}</h6>
                                    <p className='card-text text-sm'>{t`lanCommonLabelTheBigApple`}</p>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className='col-lg-3 col-sm-4 pb-2'>
                              <div className='img-div'>
                                ...
                                <div className='card-body overlay-content'>
                                  <div className='overlay-img-content'>
                                    <h6 className='card-title text-shadow text-uppercase'>{t`lanCommonLabelHyderabad`}</h6>
                                    <p className='card-text text-sm'>{t`lanCommonLabelTheBigApple`}</p>
                                  </div>
                                </div>
                              </div>
                    ...
                    <a className='carousel-control-prev' href='#myCarousel' role='button' data-slide='prev'>
                      ...
                      <span className='sr-only'>{t`lanEULabelPrevious`}</span>
                    </a>
                    <a className='carousel-control-next' href='#myCarousel' role='button' data-slide='next'>
                      <span className='carousel-control-next-icon' aria-hidden='true' />
                      <span className='sr-only'>{t`lanEULabelNext`}</span>
                    </a>
                  </div>
                </div>
              </div>
              : this.state.mountainPlaces === true
                ? <div className='container'>
                  <div className='row mb-2'>
                    <div className='col-md-12'>
                      <div className='typo-section-header-sq'>
                        <h2 className='text-align-center-sq'>{t`lanCommonLabelMountainPlaces`}</h2>
                      </div>
                    </div>
                    <div className='col-md-12 d-lg-flex align-items-center justify-content-end'>
                      <a onClick={this.handleAllHotelsList} className='text-muted text-sm'>{t`lanCommonLabelSeeAllPopularPlaces`}<i className='fas fa-angle-double-right ml-2' />
                ...
                : <div className='container'>
                  <div className='row mb-2'>
                    <div className='col-md-12'>
                      <div className='typo-section-header-sq'>
                        <h2 className='text-align-center-sq'>{t`lanCommonLabelMostPopularPlaces`}</h2>
                      </div>
                    </div>
                    <div className='col-md-12 d-lg-flex align-items-center justify-content-end'>
                      <a onClick={this.handleAllHotelsList} className='more-trigger pb-3 '>{t`lanCommonLabelSeeAllPopularPlaces`}<i className='fas fa-angle-double-right ml-2' />
                      </a>
                    </div>
                  </div>
                  <div className='row most-popular '>
                    ...
                    <div className='room-inner'>
                      <div className='room'>
                        ...
                        <div className='caption'>
                          ...
                          <div className='txt4'>
                            <a onClick={this.handleAllHotelsList}>{t`lanEULabelViewDetail`}<i className='fa fa-caret-right' aria-hidden='true' /></a>
                          </div>
                        </div>
                        <div className='select-txt'>
                          <a onClick={() => this.handleHotelInfoView(item)}><span>{t`lanEULabelSelectThisRoom`}<i className='fa fa-angle-right' aria-hidden='true' /></span></a>
                        </div>
                        <div className='room-icons'>
                          ...
                          <div className='room-price'>
                            ...
                            <div className='txt2 perNight'>{t`lanEULabelPerNight`}</div>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div className='section mt-5 create-property-landing'>
            <div className='Lyp__overlay'>{/* create-property-landing */}</div>
            <div className='container justify-content-center' style={{ position: 'relative' }}>
              <div className='row'>
                <div className='col-sm-12 text-center list-ur-prop'>
                  <p className='AM__title' style={{ color: 'white', fontSize:22, fontWeight: 500 }}>List your property on AMTOPM and open your door to rental income</p>
                  <a onClick={this.handleListYourProperty} className='text-white ampm__btn btn btn-lg btn-overlay'>List your property</a>
                </div>
              </div>
            </div>
          </div>
