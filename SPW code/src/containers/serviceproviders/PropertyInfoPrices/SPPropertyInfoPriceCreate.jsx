  ...
  render () {
    return (
      <div className='main-content' id='panel'>
        ...
        {/* ---------- Header Starts ------------- */}
        <div>
          <SPPropertyInfoPriceCreateComponent handlePricingChange={this.props.handlePricingChange} commonFuntion={this.props.commonFuntion} priceObj={this.props.priceObj} isCreateProperty={this.props.isCreateProperty} />
        </div>
        {/* <FooterComponent /> */}
      </div>
    )
